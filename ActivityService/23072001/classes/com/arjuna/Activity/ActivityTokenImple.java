...
class ActivityTokenImple extends  org.omg.CosActivity . ActivityTokenPOA 
{
...
public final ActivityToken getReference ()
	...
	if (_reference == null)
	{
	    ...
	    _reference =  org.omg.CosActivity.ActivityTokenHelper.narrow(OAInterface.corbaReference( this )) ;
...
private final Control getParentTransaction (Control tx, Control enclosedTx) throws NoSuchElementException, SystemException
	...
	try
	{
	    aCont =  com.arjuna.ArjunaOTS.ActionControlHelper.narrow(tx) ;
