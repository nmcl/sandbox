...
public class ActionErrorHelper
{
    ...
    public static org.omg.CosActivity.ActionError extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"ActionError",_s);
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivity/ActionError:1.0";
    }

    public static org.omg.CosActivity.ActionError read(
        org.omg.CORBA.portable.InputStream _stream
    )
    {
        // read and discard the repository id
        _stream.read_string();
        org.omg.CosActivity.ActionError value = new org.omg.CosActivity.ActionError();
