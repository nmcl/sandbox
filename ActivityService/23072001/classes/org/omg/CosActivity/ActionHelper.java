...
public class ActionHelper
{
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            _type = _orb().create_interface_tc(id(), "Action");
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivity/Action:1.0";
    }
    ...
    public static org.omg.CosActivity.Action narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof org.omg.CosActivity.Action)
        {
            return (org.omg.CosActivity.Action)_obj;
        }
        if (_obj._is_a(id()))
        {
            org.omg.CosActivity._ActionStub _ref = new org.omg.CosActivity._ActionStub();
