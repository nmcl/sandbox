...
public class ActionNotFoundHelper
{
    ...
    public static org.omg.CosActivity.ActionNotFound extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"ActionNotFound",_s);
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivity/ActionNotFound:1.0";
    }

    public static org.omg.CosActivity.ActionNotFound read(
        org.omg.CORBA.portable.InputStream _stream
    )
    {
        // read and discard the repository id
        _stream.read_string();
        org.omg.CosActivity.ActionNotFound value = new org.omg.CosActivity.ActionNotFound();
