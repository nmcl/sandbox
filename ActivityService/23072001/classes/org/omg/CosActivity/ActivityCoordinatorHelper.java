...
public class ActivityCoordinatorHelper
{
    ...
    public static org.omg.CosActivity.ActivityCoordinator extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            _type = _orb().create_interface_tc(id(), "ActivityCoordinator");
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivity/ActivityCoordinator:1.0";
    }

    public static org.omg.CosActivity.ActivityCoordinator read(
    ...
    public static org.omg.CosActivity.ActivityCoordinator narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof org.omg.CosActivity.ActivityCoordinator)
        {
            return (org.omg.CosActivity.ActivityCoordinator)_obj;
        }
        if (_obj._is_a(id()))
        {
            org.omg.CosActivity._ActivityCoordinatorStub _ref = new org.omg.CosActivity._ActivityCoordinatorStub();
