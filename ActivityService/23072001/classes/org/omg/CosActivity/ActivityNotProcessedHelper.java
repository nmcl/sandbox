...
public class ActivityNotProcessedHelper
{
    ...
    public static org.omg.CosActivity.ActivityNotProcessed extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"ActivityNotProcessed",_s);
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivity/ActivityNotProcessed:1.0";
    }

    public static org.omg.CosActivity.ActivityNotProcessed read(
        org.omg.CORBA.portable.InputStream _stream
    )
    {
        // read and discard the repository id
        _stream.read_string();
        org.omg.CosActivity.ActivityNotProcessed value = new org.omg.CosActivity.ActivityNotProcessed();
