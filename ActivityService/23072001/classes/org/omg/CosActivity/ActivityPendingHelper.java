...
public class ActivityPendingHelper
{
    ...
    public static org.omg.CosActivity.ActivityPending extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"ActivityPending",_s);
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivity/ActivityPending:1.0";
    }

    public static org.omg.CosActivity.ActivityPending read(
        org.omg.CORBA.portable.InputStream _stream
    )
    {
        // read and discard the repository id
        _stream.read_string();
        org.omg.CosActivity.ActivityPending value = new org.omg.CosActivity.ActivityPending();
