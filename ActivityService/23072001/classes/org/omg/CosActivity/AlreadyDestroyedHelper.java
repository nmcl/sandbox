...
public class AlreadyDestroyedHelper
{
    public static void insert(
        org.omg.CORBA.Any any,
        org.omg.CosActivity.AlreadyDestroyed value
    )
    {
        any.type(type());
    ...
    public static org.omg.CosActivity.AlreadyDestroyed extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"AlreadyDestroyed",_s);
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivity/AlreadyDestroyed:1.0";
    }

    public static org.omg.CosActivity.AlreadyDestroyed read(
        org.omg.CORBA.portable.InputStream _stream
    )
    {
        // read and discard the repository id
        _stream.read_string();
        org.omg.CosActivity.AlreadyDestroyed value = new org.omg.CosActivity.AlreadyDestroyed();
