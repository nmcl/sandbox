...
public class CompletionStatusHelper
{
    ...
    public static org.omg.CosActivity.CompletionStatus extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            String _e[] = {"CompletionStatusSuccess", "CompletionStatusFail", "CompletionStatusFailOnly"};
            _type = _orb().create_enum_tc(id(), "CompletionStatus", _e);
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivity/CompletionStatus:1.0";
    }

    public static org.omg.CosActivity.CompletionStatus read(
        org.omg.CORBA.portable.InputStream _stream
    )
    {
        org.omg.CosActivity.CompletionStatus value = org.omg.CosActivity.CompletionStatus.from_int(_stream.read_ulong());
        return value;
    }
