...
public class GlobalIdHelper
{
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            org.omg.CORBA.TypeCode _tc_td_seq_1 = _orb().get_primitive_tc(org.omg.CORBA.TCKind.tk_octet);
            org.omg.CORBA.TypeCode _tc_td_0 = _orb().create_sequence_tc(0, _tc_td_seq_1);
            _type = _orb().create_alias_tc("IDL:omg.org/CosActivity/GlobalId:1.0", "GlobalId", _tc_td_0);
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivity/GlobalId:1.0";
    }
