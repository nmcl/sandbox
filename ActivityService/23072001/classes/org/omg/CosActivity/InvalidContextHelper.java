...
public class InvalidContextHelper
{
    ...
    public static org.omg.CosActivity.InvalidContext extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"InvalidContext",_s);
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivity/InvalidContext:1.0";
    }

    public static org.omg.CosActivity.InvalidContext read(
        org.omg.CORBA.portable.InputStream _stream
    )
    {
        // read and discard the repository id
        _stream.read_string();
        org.omg.CosActivity.InvalidContext value = new org.omg.CosActivity.InvalidContext();
