...
public class InvalidParentContextHelper
{
    ...
    public static org.omg.CosActivity.InvalidParentContext extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"InvalidParentContext",_s);
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivity/InvalidParentContext:1.0";
    }

    public static org.omg.CosActivity.InvalidParentContext read(
        org.omg.CORBA.portable.InputStream _stream
    )
    {
        // read and discard the repository id
        _stream.read_string();
        org.omg.CosActivity.InvalidParentContext value = new org.omg.CosActivity.InvalidParentContext();
