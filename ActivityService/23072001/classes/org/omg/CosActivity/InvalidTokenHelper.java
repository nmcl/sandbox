...
public class InvalidTokenHelper
{
    ...
    public static org.omg.CosActivity.InvalidToken extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"InvalidToken",_s);
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivity/InvalidToken:1.0";
    }

    public static org.omg.CosActivity.InvalidToken read(
        org.omg.CORBA.portable.InputStream _stream
    )
    {
        // read and discard the repository id
        _stream.read_string();
        org.omg.CosActivity.InvalidToken value = new org.omg.CosActivity.InvalidToken();
