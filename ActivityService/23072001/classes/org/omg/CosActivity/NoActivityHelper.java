...
public class NoActivityHelper
{
    ...
    public static org.omg.CosActivity.NoActivity extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"NoActivity",_s);
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivity/NoActivity:1.0";
    }

    public static org.omg.CosActivity.NoActivity read(
        org.omg.CORBA.portable.InputStream _stream
    )
    {
        // read and discard the repository id
        _stream.read_string();
        org.omg.CosActivity.NoActivity value = new org.omg.CosActivity.NoActivity();
