...
public class PropertyGroupHelper
{
    ...
    public static org.omg.CosActivity.PropertyGroup extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            _type = _orb().create_interface_tc(id(), "PropertyGroup");
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivity/PropertyGroup:1.0";
    }

    public static org.omg.CosActivity.PropertyGroup read(
    ...
    public static org.omg.CosActivity.PropertyGroup narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof org.omg.CosActivity.PropertyGroup)
        {
            return (org.omg.CosActivity.PropertyGroup)_obj;
        }
        if (_obj._is_a(id()))
        {
            org.omg.CosActivity._PropertyGroupStub _ref = new org.omg.CosActivity._PropertyGroupStub();
