...
public class PropertyGroupUnknownHelper
{
    public static void insert(
        org.omg.CORBA.Any any,
        org.omg.CosActivity.PropertyGroupUnknown value
    )
    {
        any.type(type());
    ...
    public static org.omg.CosActivity.PropertyGroupUnknown extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"PropertyGroupUnknown",_s);
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivity/PropertyGroupUnknown:1.0";
    }

    public static org.omg.CosActivity.PropertyGroupUnknown read(
        org.omg.CORBA.portable.InputStream _stream
    )
    {
        // read and discard the repository id
        _stream.read_string();
        org.omg.CosActivity.PropertyGroupUnknown value = new org.omg.CosActivity.PropertyGroupUnknown();
