...
public class SignalSetActiveHelper
{
    ...
    public static org.omg.CosActivity.SignalSetActive extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"SignalSetActive",_s);
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivity/SignalSetActive:1.0";
    }

    public static org.omg.CosActivity.SignalSetActive read(
        org.omg.CORBA.portable.InputStream _stream
    )
    {
        // read and discard the repository id
        _stream.read_string();
        org.omg.CosActivity.SignalSetActive value = new org.omg.CosActivity.SignalSetActive();
