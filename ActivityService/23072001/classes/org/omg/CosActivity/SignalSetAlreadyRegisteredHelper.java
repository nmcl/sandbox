...
public class SignalSetAlreadyRegisteredHelper
{
    ...
    public static org.omg.CosActivity.SignalSetAlreadyRegistered extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"SignalSetAlreadyRegistered",_s);
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivity/SignalSetAlreadyRegistered:1.0";
    }

    public static org.omg.CosActivity.SignalSetAlreadyRegistered read(
        org.omg.CORBA.portable.InputStream _stream
    )
    {
        // read and discard the repository id
        _stream.read_string();
        org.omg.CosActivity.SignalSetAlreadyRegistered value = new org.omg.CosActivity.SignalSetAlreadyRegistered();
