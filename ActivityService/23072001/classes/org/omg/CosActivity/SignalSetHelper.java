...
public class SignalSetHelper
{
    ...
    public static org.omg.CosActivity.SignalSet extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            _type = _orb().create_interface_tc(id(), "SignalSet");
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivity/SignalSet:1.0";
    }

    public static org.omg.CosActivity.SignalSet read(
    ...
    public static org.omg.CosActivity.SignalSet narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof org.omg.CosActivity.SignalSet)
        {
            return (org.omg.CosActivity.SignalSet)_obj;
        }
        if (_obj._is_a(id()))
        {
            org.omg.CosActivity._SignalSetStub _ref = new org.omg.CosActivity._SignalSetStub();
