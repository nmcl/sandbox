...
public class SignalSetUnknownHelper
{
    ...
    public static org.omg.CosActivity.SignalSetUnknown extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"SignalSetUnknown",_s);
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivity/SignalSetUnknown:1.0";
    }

    public static org.omg.CosActivity.SignalSetUnknown read(
        org.omg.CORBA.portable.InputStream _stream
    )
    {
        // read and discard the repository id
        _stream.read_string();
        org.omg.CosActivity.SignalSetUnknown value = new org.omg.CosActivity.SignalSetUnknown();
