...
public class SubordinateSignalSetHelper
{
    public static void insert(
        org.omg.CORBA.Any any,
        org.omg.CosActivity.SubordinateSignalSet value
    )
    {
        any.type(type());
    ...
    public static org.omg.CosActivity.SubordinateSignalSet extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            _type = _orb().create_interface_tc(id(), "SubordinateSignalSet");
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivity/SubordinateSignalSet:1.0";
    }

    public static org.omg.CosActivity.SubordinateSignalSet read(
    ...
    public static org.omg.CosActivity.SubordinateSignalSet narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof org.omg.CosActivity.SubordinateSignalSet)
        {
            return (org.omg.CosActivity.SubordinateSignalSet)_obj;
        }
        if (_obj._is_a(id()))
        {
            org.omg.CosActivity._SubordinateSignalSetStub _ref = new org.omg.CosActivity._SubordinateSignalSetStub();
