...
public class _SubordinateSignalSetStub
    extends org.omg.CORBA.portable.ObjectImpl
    implements SubordinateSignalSet, org.omg.CosActivity.SignalSet
{
    final public static java.lang.Class _opsClass = SubordinateSignalSetOperations.class;
    ...
    public java.lang.String signal_set_name()
    {
        while (true) {
            if(!_is_local()) {
                ...
                SubordinateSignalSetOperations _self = (SubordinateSignalSetOperations)_so.servant;
                try {
    ...
    )
    {
        while (true) {
            if(!_is_local()) {
                ...
                org.omg.CORBA.portable.InputStream _input = null;
                try {
                    _output = _request("set_signal", true);
                ...
                org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke("set_signal", _opsClass);
                if (_so == null) {
                    continue;
                }
                SubordinateSignalSetOperations _self = (SubordinateSignalSetOperations)_so.servant;
                try {
                    _self.set_signal(sig);
                    return;
                }
                finally {
                    _servant_postinvoke(_so);
    ...
    public org.omg.CosActivity.Outcome get_current_outcome() throws org.omg.CosActivity.SignalSetInactive
    {
        while (true) {
            if(!_is_local()) {
                ...
                org.omg.CosActivity.Outcome _result;
                try {
                    _output = _request("get_current_outcome", true);
                    _input = _invoke(_output);
                    _result = org.omg.CosActivity.OutcomeHelper.read(_input);
                    return _result;
                }
                ...
                org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke("get_current_outcome", _opsClass);
                if (_so == null) {
                    continue;
                }
                SubordinateSignalSetOperations _self = (SubordinateSignalSetOperations)_so.servant;
                try {
                    return _self.get_current_outcome();
                }
                finally {
                    _servant_postinvoke(_so);
                }
    ...
    {"IDL:omg.org/CosActivity/SubordinateSignalSet:1.0", "IDL:omg.org/CosActivity/SignalSet:1.0"};
