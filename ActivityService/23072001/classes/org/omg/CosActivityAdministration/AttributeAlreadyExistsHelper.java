...
public class AttributeAlreadyExistsHelper
{
    ...
    public static org.omg.CosActivityAdministration.AttributeAlreadyExists extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"AttributeAlreadyExists",_s);
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivityAdministration/AttributeAlreadyExists:1.0";
    }

    public static org.omg.CosActivityAdministration.AttributeAlreadyExists read(
        org.omg.CORBA.portable.InputStream _stream
    )
    {
        // read and discard the repository id
        _stream.read_string();
        org.omg.CosActivityAdministration.AttributeAlreadyExists value = new org.omg.CosActivityAdministration.AttributeAlreadyExists();
