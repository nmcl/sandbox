...
public class CurrentHelper
{
    ...
    public static org.omg.CosActivityAdministration.Current extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    {
        return "IDL:omg.org/CosActivityAdministration/Current:1.0";
    }

    public static org.omg.CosActivityAdministration.Current read(
    ...
    public static org.omg.CosActivityAdministration.Current narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof org.omg.CosActivityAdministration.Current)
        {
            return (org.omg.CosActivityAdministration.Current)_obj;
        }
        if (_obj._is_a(id()))
        {
            org.omg.CosActivityAdministration._CurrentStub _ref = new org.omg.CosActivityAdministration._CurrentStub();
