...
public class PropertyGroupAlreadyRegisteredHelper
{
    ...
    public static org.omg.CosActivityAdministration.PropertyGroupAlreadyRegistered extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"PropertyGroupAlreadyRegistered",_s);
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivityAdministration/PropertyGroupAlreadyRegistered:1.0";
    }

    public static org.omg.CosActivityAdministration.PropertyGroupAlreadyRegistered read(
        org.omg.CORBA.portable.InputStream _stream
    )
    {
        // read and discard the repository id
        _stream.read_string();
        org.omg.CosActivityAdministration.PropertyGroupAlreadyRegistered value = new org.omg.CosActivityAdministration.PropertyGroupAlreadyRegistered();
