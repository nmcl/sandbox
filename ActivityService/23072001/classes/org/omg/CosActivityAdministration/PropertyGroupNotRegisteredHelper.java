...
public class PropertyGroupNotRegisteredHelper
{
    ...
    public static org.omg.CosActivityAdministration.PropertyGroupNotRegistered extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"PropertyGroupNotRegistered",_s);
        }
        return _type;
    }
    ...
    {
        return "IDL:omg.org/CosActivityAdministration/PropertyGroupNotRegistered:1.0";
    }

    public static org.omg.CosActivityAdministration.PropertyGroupNotRegistered read(
        org.omg.CORBA.portable.InputStream _stream
    )
    {
        // read and discard the repository id
        _stream.read_string();
        org.omg.CosActivityAdministration.PropertyGroupNotRegistered value = new org.omg.CosActivityAdministration.PropertyGroupNotRegistered();
