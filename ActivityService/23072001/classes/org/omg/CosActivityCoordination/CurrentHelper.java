...
public class CurrentHelper
{
    public static void insert(
        ...
        org.omg.CosActivityCoordination.Current value
    )
    {
        any.type(type());
    ...
    public static org.omg.CosActivityCoordination.Current extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    {
        return "IDL:omg.org/CosActivityCoordination/Current:1.0";
    }

    public static org.omg.CosActivityCoordination.Current read(
    ...
    public static org.omg.CosActivityCoordination.Current narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof org.omg.CosActivityCoordination.Current)
        {
            return (org.omg.CosActivityCoordination.Current)_obj;
        }
        if (_obj._is_a(id()))
        {
            org.omg.CosActivityCoordination._CurrentStub _ref = new org.omg.CosActivityCoordination._CurrentStub();
