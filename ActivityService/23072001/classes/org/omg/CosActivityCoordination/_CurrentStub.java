...
public class _CurrentStub
    ...
    implements Current, org.omg.CosActivityAdministration.Current
{
    ...
    ) throws org.omg.CosActivity.SignalSetUnknown, org.omg.CosActivity.NoActivity, org.omg.CosActivity.ActivityNotProcessed
    {
        while (true) {
            if(!_is_local()) {
                ...
                org.omg.CosActivity.Outcome _result;
                try {
                    _output = _request("broadcast", true);
                    _output.write_string(signal_set_name);
                    org.omg.CosActivity.CompletionStatusHelper.write(_output, cs);
                    _input = _invoke(_output);
                    _result = org.omg.CosActivity.OutcomeHelper.read(_input);
                ...
                org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke("broadcast", _opsClass);
                if (_so == null) {
                    continue;
                }
                CurrentOperations _self = (CurrentOperations)_so.servant;
                try {
                    return _self.broadcast(signal_set_name, cs);
                }
                finally {
                    _servant_postinvoke(_so);
                }
    ...
    {"IDL:omg.org/CosActivityCoordination/Current:1.0", "IDL:omg.org/CosActivityAdministration/Current:1.0", "IDL:omg.org/CosActivity/Current:1.0"};
