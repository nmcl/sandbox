 ...
 * UK.
 *
 * $Id: barSignalSet.javatmpl,v 1.1 2001/07/23 13:45:05 nmcl Exp $
 */
...
public class barSignalSet extends  org.omg.CosActivity . SignalSetPOA 
{
...
public String signal_set_name () throws SystemException
    {
	return "com.arjuna.ActivityTests.barSignalSet";
    }
...
public Signal get_signal (BooleanHolder lastSignal) throws SystemException
	...
	if (!_finished)
	{
	    Signal s = new Signal("barSignal", signal_set_name(), null);
