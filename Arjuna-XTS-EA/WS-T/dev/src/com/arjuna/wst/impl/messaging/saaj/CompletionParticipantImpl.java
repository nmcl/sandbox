 ...
 *
 * CompletionParticipantImpl.java
 */
...
public class CompletionParticipantImpl implements MessageListener, CompletionParticipant, java.io.Serializable
{
    public CompletionParticipantImpl(String serviceURI)
    ...
    public void onMessage(SOAPEnvelope envelope)
    {
        ...
        {
            System.err.println("CompletionParticipantImpl: " + exception);
        }
        catch (Error error)
        {
            System.err.println("CompletionParticipantImpl: " + error);
        }
    }
