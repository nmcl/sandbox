 ...
 *
 * CompletionWithAckCoordinatorImpl.java
 */
...
public class CompletionWithAckCoordinatorImpl implements MessageListener, CompletionWithAckCoordinator, java.io.Serializable
{
    public CompletionWithAckCoordinatorImpl(String serviceURI)
    ...
    public void onMessage(SOAPEnvelope envelope)
    {
        ...
        {
            System.err.println("CompletionWithAckCoordinatorImpl: " + exception);
        }
        catch (Error error)
        {
            System.err.println("CompletionWithAckCoordinatorImpl: " + error);
        }
    }
        ...
        throws MarshalException
    {
        ...
        try
        {
            ...
            else if ((bodyElementName.getLocalName().equals(XMLUtil.NOTIFIED_TAG) && bodyElementName.getURI().equals(XMLUtil.WSTX_NAMESPACE_URI)))
            {
