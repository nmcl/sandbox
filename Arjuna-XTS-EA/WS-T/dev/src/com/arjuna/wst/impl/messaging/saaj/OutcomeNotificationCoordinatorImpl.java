 ...
 *
 * OutcomeNotificationCoordinatorImpl.java
 */
...
public class OutcomeNotificationCoordinatorImpl implements MessageListener, OutcomeNotificationCoordinator, java.io.Serializable
{
    public OutcomeNotificationCoordinatorImpl(String serviceURI)
    ...
    public void onMessage(SOAPEnvelope envelope)
    {
        ...
        {
            System.err.println("OutcomeNotificationCoordinatorImpl: " + exception);
        }
        catch (Error error)
        {
            System.err.println("OutcomeNotificationCoordinatorImpl: " + error);
        }
    }
        ...
        throws MarshalException
    {
        ...
        try
        {
            ...
            if ((bodyElementName.getLocalName().equals(XMLUtil.NOTIFIED_TAG) && bodyElementName.getURI().equals(XMLUtil.WSTX_NAMESPACE_URI)))
            {
                ...
                if (parameters.hasNext())
                {
                    ...
                    if (parameterName.getLocalName().equals(XMLUtil.TARGET_PROTOCOL_SERVICE_TAG) && parameterName.getURI().equals(XMLUtil.WSTX_NAMESPACE_URI))
                        notifiedMessage.targetProtocolService = PortReferenceHelper.fromXML(envelope, parameter);
                    else
                ...
                if (parameters.hasNext())
                {
                    ...
                    if (parameterName.getLocalName().equals(XMLUtil.SOURCE_PROTOCOL_SERVICE_TAG) && parameterName.getURI().equals(XMLUtil.WSTX_NAMESPACE_URI))
                        notifiedMessage.sourceProtocolService = PortReferenceHelper.fromXML(envelope, parameter);
                    else
                        throw new MarshalException("Unexpected element: " + parameterName.getLocalName() + "; " + parameterName.getURI());
                }
                else
