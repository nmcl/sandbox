 ...
 * UK.
 *
 * $Id: ActivityReaper.java,v 1.2 2003/04/04 14:59:51 nmcl Exp $
 */
 ...
 * @version $Id: ActivityReaper.java,v 1.2 2003/04/04 14:59:51 nmcl Exp $
 * @since 1.0.
 */
...
public class ActivityReaper
{
	...
	if (e != null)
	{
		...
		if (problem)
		{
		    ...
		    if (error)
		    {
			System.err.println("ActivityReaper: could not terminate "+e._activity);
		    }
		}
	    }
