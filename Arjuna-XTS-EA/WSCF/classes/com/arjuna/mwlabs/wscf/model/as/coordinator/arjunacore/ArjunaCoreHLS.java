 ...
 * UK.
 *
 * $Id: ArjunaCoreHLS.java,v 1.2 2003/03/04 12:55:57 nmcl Exp $
 */
 ...
 * @version $Id: ArjunaCoreHLS.java,v 1.2 2003/03/04 12:55:57 nmcl Exp $
 * @since 1.0.
 */

public class ArjunaCoreHLS implements HLS, CoordinatorManagerService, UserCoordinatorService
{
	...
	try
	{
		...
		throw new BegunFailedException("ArjunaCoreHLS.begun: "+ActionStatus.stringForm(status));
	    else
	    {
    ...
    public void setResponse (String id, Message notification, Outcome response, Qualifier[] quals) throws InvalidParticipantException, WrongStateException, NoCoordinatorException, SystemException
    {
    ...
    private final ACCoordinator currentCoordinator () throws NoCoordinatorException, SystemException
    {
