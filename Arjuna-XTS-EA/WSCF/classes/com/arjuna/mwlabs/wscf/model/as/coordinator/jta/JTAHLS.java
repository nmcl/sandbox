 ...
 * UK.
 *
 * $Id: JTAHLS.java,v 1.2 2003/03/04 12:55:57 nmcl Exp $
 */

package com.arjuna.mwlabs.wscf.model.as.coordinator.jta;

import com.arjuna.mwlabs.wscf.model.as.coordinator.xa.context.soap.JTAContextImple;
 ...
 * @version $Id: JTAHLS.java,v 1.2 2003/03/04 12:55:57 nmcl Exp $
 * @since 1.0.
 */
...
public class JTAHLS implements HLS, CoordinatorManagerService, UserCoordinatorService
{
	...
	try
	{
		...
		throw new BegunFailedException("JTAHLS.begun: "+status);
	    else
	    {
    ...
    private static final String _defaultClassName = com.hp.mwlabs.ts.jta.transaction.arjunacore.TransactionManagerImple.class.getName();
