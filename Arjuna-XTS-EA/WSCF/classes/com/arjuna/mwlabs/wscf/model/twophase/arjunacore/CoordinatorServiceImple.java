 ...
 * UK.
 *
 * $Id: CoordinatorServiceImple.java,v 1.3 2003/04/04 15:00:06 nmcl Exp $
 */
 ...
 * @version $Id: CoordinatorServiceImple.java,v 1.3 2003/04/04 15:00:06 nmcl Exp $
 * @since 1.0.
 */
...
public class CoordinatorServiceImple implements UserCoordinator, CoordinatorManager
{
	...
	try
	{
	     ...
	     * TODO
	     *
	     * This only works because we know we only have one ALS
	     * registered, so we can always check the outcome returned and
	     * make sure it is ours!
	     *
	     * Check if this is a CompositeOutcome and then iterate through
	     * to find our status!!
	     */
		...
		if (res instanceof CoordinationOutcome)
		{
		    ...
		    throw new HeuristicHazardException("Unknown response.");
	    }
	}
