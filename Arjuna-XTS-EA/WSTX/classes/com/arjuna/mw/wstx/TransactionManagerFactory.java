 ...
 * UK.
 *
 * $Id: TransactionManagerFactory.java,v 1.4 2003/03/14 09:55:23 nmcl Exp $
 */
 ...
 * @version $Id: TransactionManagerFactory.java,v 1.4 2003/03/14 09:55:23 nmcl Exp $
 * @since 1.0.
 */
...
public class TransactionManagerFactory
{
	...
	try
	{
	    ...
	    if (doc == null)
	    {
		System.err.println("Failed to create "+com.arjuna.mwlabs.wstx.model.as.twophase.TwoPhaseTxManager.class.getName());
	    }
	    else
	    {
