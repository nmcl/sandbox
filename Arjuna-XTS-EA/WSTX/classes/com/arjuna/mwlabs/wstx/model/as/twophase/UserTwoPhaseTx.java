 ...
 * UK.
 *
 * $Id: UserTwoPhaseTx.java,v 1.1 2003/02/03 11:01:29 nmcl Exp $
 */
 ...
 * @version $Id: UserTwoPhaseTx.java,v 1.1 2003/02/03 11:01:29 nmcl Exp $
 * @since 1.0.
 */
...
public class UserTwoPhaseTx implements UserTransaction
{
	...
	{
	    throw new InvalidTransactionException("Transaction has active children.");
	}
	...
	try
	{
	    ...
	    {
		System.err.println("Unknown coordinator Id.");
	...
	if (out instanceof CoordinationOutcome)
	{
	    ...
	    throw new HeuristicHazardException("Unknown end result.");
    }
