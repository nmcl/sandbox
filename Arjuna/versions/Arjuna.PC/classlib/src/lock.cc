 ...
 * UK.
 *
 * $Id: Lock.cc,v 1.2 1993/11/16 09:55:32 ngdp Exp $
 */
...
static const char RCSid[] = "$Id: Lock.cc,v 1.2 1993/11/16 09:55:32 ngdp Exp $";

static Uid applicUid;		/* In case lock set outside AA */

// removed :: for MSDOS or OS/2 as some compilers have a macro for this
...
#ifdef DEBUG
    debug_stream << TRIVIAL_FUNCS << FAC_CONCURRENCY_CONTROL << VIS_PUBLIC;
    debug_stream << "Lock::getOwner()" << endl;
#endif
...
#ifdef DEBUG
    debug_stream << TRIVIAL_FUNCS << FAC_CONCURRENCY_CONTROL << VIS_PUBLIC;
    debug_stream << "Lock::getStatus()" << endl;
#endif
...
#ifdef DEBUG
    debug_stream << TRIVIAL_FUNCS << FAC_CONCURRENCY_CONTROL << VIS_PUBLIC;
    debug_stream << "Lock::isAction()" << endl;
#endif
...
#ifdef DEBUG
    debug_stream << TRIVIAL_FUNCS << FAC_CONCURRENCY_CONTROL << VIS_PUBLIC;
    debug_stream << "Lock::setOwner(" << newOwner << ", " << isAction << ")" << endl;
#endif
...
#ifdef DEBUG
    debug_stream << TRIVIAL_FUNCS << FAC_CONCURRENCY_CONTROL << VIS_PUBLIC;
    debug_stream << "Lock::setStatus(" << newStatus << ")" << endl;
#endif
