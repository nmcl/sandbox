 ...
 * UK.
 *
 * $Id: LockList.cc,v 1.1 1993/11/03 12:29:53 nmcl Exp $
 */
...
static const char RCSid[] = "$Id: LockList.cc,v 1.1 1993/11/03 12:29:53 nmcl Exp $";
		     ...
		     count(0)
{
    ...
    debug_stream << "LockList::LockList()\n" << flush;
#endif
}
...
Boolean LockList::insert ( Lock *newlock )
{
    ...
    debug_stream << "LockList::insert(" << (void *)newlock << ")\n" << flush;
#endif
...
#ifdef DEBUG
    debug_stream << FUNCTIONS << FAC_CONCURRENCY_CONTROL << VIS_PUBLIC;
    debug_stream << "LockList::push(" << (void *)newLock << ")\n" << flush;
#endif
...
#ifdef DEBUG
    debug_stream << FUNCTIONS << FAC_CONCURRENCY_CONTROL << VIS_PUBLIC;
    debug_stream << "LockList::forgetNext(" << (void *)current << ")\n" << flush;
#endif
