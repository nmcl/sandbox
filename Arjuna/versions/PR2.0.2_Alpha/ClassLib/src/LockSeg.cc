 ...
 * UK.
 *
 * $Id: LockSeg.cc,v 1.2 1993/11/16 09:55:39 ngdp Exp $
 */
...
static const char RCSid[] = "$Id: LockSeg.cc,v 1.2 1993/11/16 09:55:39 ngdp Exp $";
                         ...
                         : SharedSegment()
{
	...
	error_stream << WARNING 
		     << "LockSegment::LockSegment failed unexpectedly" << endl;
...
Boolean LockSegment::freeSlot ( long slotNo )
{
	...
	if (slotNo > 0)
	{
	    ...
	    error_stream << WARNING
			 << "LockSegment::freeSlot() attempting to free slot "
			 << slotNo << endl;
	return TRUE;
    }
