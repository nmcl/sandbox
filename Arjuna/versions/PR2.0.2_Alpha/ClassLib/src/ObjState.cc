 ...
 * UK.
 *
 * $Id: ObjState.cc,v 1.3 1993/11/20 10:59:28 nmcl Exp $
 */
...
static const char RCSid[] = "$Id: ObjState.cc,v 1.3 1993/11/20 10:59:28 nmcl Exp $";
...
void ObjectState::copytype ( const TypeName tName )
{
	...
	::memset(imageType, '\0', strlen((char *) tName) + 1);
	::memcpy((char *) imageType, (char *) tName, strlen((char *) tName) + 1);
    }
    else
	imageType = 0;
}
