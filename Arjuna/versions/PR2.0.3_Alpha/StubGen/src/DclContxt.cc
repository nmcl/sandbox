 ...
 * UK.
 *
 * $Id: DclContxt.cc,v 1.10 1993/11/02 12:36:52 ngdp Exp $
 */
...
static const char RCSid[] = "$Id: DclContxt.cc,v 1.10 1993/11/02 12:36:52 ngdp Exp $";
...
ostream& DeclContext::printOn ( ostream& s, DeclStyle ds, char* sep ) const
{    
    Declaration *nextArg;
    int i = 0;
    ...
    {
	if ( i < entryCount)
	    nextArg->printDecl(s, ds, sep, FALSE, FALSE, TRUE);
	else
	    nextArg->printDecl(s, ds, "", FALSE, FALSE, TRUE);
    }
