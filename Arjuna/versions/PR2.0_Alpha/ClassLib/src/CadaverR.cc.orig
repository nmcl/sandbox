 ...
 * UK.
 *
 * $Id: CadaverR.cc,v 1.12 1993/03/22 13:33:53 n048z Exp $
 */
...
static const char RCSid[] = "$Id: CadaverR.cc,v 1.12 1993/03/22 13:33:53 n048z Exp $";
			       ...
			       osUsed(0)
{
    ...
    {
	debug_stream << CONSTRUCTORS << FAC_ABSTRACT_REC << VIS_PUBLIC;
	debug_stream << "setting store used to " << objStore->type() << " for " << sm->type() << endl;
