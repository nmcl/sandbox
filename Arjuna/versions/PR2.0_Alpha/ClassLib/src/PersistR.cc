 ...
 * UK.
 *
 * $Id: PersistR.cc,v 1.13 1993/03/22 09:20:03 ngdp Exp $
 */
...
static const char RCSid[] = "$Id: PersistR.cc,v 1.13 1993/03/22 09:20:03 ngdp Exp $";
...
Boolean PersistenceRecord::restore_state ( ObjectState&, ObjectType )
{
...
Boolean PersistenceRecord::save_state ( ObjectState& os, ObjectType )
{
    Uid aUid(getUidOfObject());
    

    return (Boolean) (aUid.pack(os) && os.pack(getTypeOfObject()));
}
