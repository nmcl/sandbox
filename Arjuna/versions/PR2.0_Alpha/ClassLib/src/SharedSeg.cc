 ...
 * UK.
 *
 * $Id: SharedSeg.cc,v 1.14 1993/03/22 09:20:13 ngdp Exp $
 */
...
static const char RCSid[] = "$Id: SharedSeg.cc,v 1.14 1993/03/22 09:20:13 ngdp Exp $";
...
#ifdef DEBUG
    debug_stream << CONSTRUCTORS << FAC_SHMEM << VIS_PUBLIC;
    debug_stream << "SharedSegment::SharedSegment(" << smId << ")\n" << flush;
#endif
}
...
void SharedSegment::dumpMem ( const char *fileName ) const
{
    ...
    debug_stream << "SharedSegment::dumpMem(" << fileName << ")\n" << flush;
#endif
			       ...
			       segVaddr(0)
{
    ...
    debug_stream << "SharedSegment::SharedSegment()\n" << flush;
#endif
}
...
char *SharedSegment::smInit ( const key_t smKey, size_t smSize )
{
    ...
    debug_stream << "SharedSegment::smInit(" << smKey << ", " << smSize << ")\n" << flush;
#endif
