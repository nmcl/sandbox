 ...
 * UK.
 *
 * $Id: CadaverLR.cc,v 1.8 1993/03/22 09:19:34 ngdp Exp $
 */
...
static const char RCSid[] = "$Id: CadaverLR.cc,v 1.8 1993/03/22 09:19:34 ngdp Exp $";
...
void CadaverLockRecord::nested_commit ()
{
    ...
    manager.propagate(AtomicAction::Current()->get_uid());
}
