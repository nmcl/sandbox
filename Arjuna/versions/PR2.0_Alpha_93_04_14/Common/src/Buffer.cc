 ...
 * UK.
 *
 * $Id: Buffer.cc,v 1.29 1993/03/18 14:17:23 nsmw Exp $
 */
...
static const char RCSid[] = "$Id: Buffer.cc,v 1.29 1993/03/18 14:17:23 nsmw Exp $";
...
Boolean Buffer::operator== (const Buffer& buff)
{
