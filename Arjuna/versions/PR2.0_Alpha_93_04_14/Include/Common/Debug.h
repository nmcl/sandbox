 ...
 * UK.
 *
 * $Id: Debug.h,v 1.12 1993/04/02 10:09:49 ngdp Exp $
 */
...
static const int MAXNEST = 256 * 3;
...
private:
    ...
    DebugLevel dbgLevel[MAXNEST];
    FacilityCode dbgFac[MAXNEST];
    VisibilityLevel dbgVis[MAXNEST];
