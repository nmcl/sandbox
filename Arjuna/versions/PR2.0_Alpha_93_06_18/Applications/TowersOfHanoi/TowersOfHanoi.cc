...
/*
 * $Id: TowersOfHanoi.cc,v 1.6 1993/09/21 15:26:06 nmcl Exp $
 */
...
#endif
{
    ...
    for (int i = 1; i < argc; i++)
    {
	    ...
	    {
		cerr << "Cannot have new 'replicated' object" << endl;
		err = 1;
	    }
        }
	...
	else if (strcmp("-replicated", argv[i]) == 0)
	{
	    ...
	    {
		cerr << "Cannot have replicated 'new' object" << endl;
		err = 1;
	    }
	}
	else 
    ...
    if (err != 1)
    {
	TowersDispatch* towersDis = new TowersDispatch(isReplicated);
