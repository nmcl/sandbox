 ...
 * UK.
 *
 * $Id: Decl.h,v 1.10 1993/11/02 12:36:42 ngdp Exp $
 */
...
public:
    ...
    StubModifier getMarshall ();
    StubModifier getRemote ();
    StubModifier getTransfer ();

    void marshall (ostream&, Direction, DeclStyle, const String&);

    Boolean produceAllStubs (ostream&);

    Boolean produceMarshallCode (ostream&, Direction, const String&);
    Boolean produceMarshallDefs (ostream&, DeclStyle);
