 ...
 * UK.
 *
 * $Id: CadaverLR.cc,v 1.6 1993/12/14 14:36:11 nmcl Exp $
 */
...
static const char RCSid[] = "$Id: CadaverLR.cc,v 1.6 1993/12/14 14:36:11 nmcl Exp $";
...
Boolean CadaverLockRecord::nestedAbort ()
{
    ...
    return (manager.releaseAll(AtomicAction::Current()->get_uid()) == RELEASED 
	    ? TRUE : FALSE);
}
...
Boolean CadaverLockRecord::nestedCommit ()
{
    ...
    return (manager.propagate(curr->get_uid(),
		      curr->parent()->get_uid())? TRUE : FALSE);
}
