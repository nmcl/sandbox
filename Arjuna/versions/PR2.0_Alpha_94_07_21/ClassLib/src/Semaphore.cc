 ...
 * UK.
 *
 * $Id: Semaphore.cc,v 1.2 1993/11/16 09:55:44 ngdp Exp $
 */
...
static const char RCSid[] = "$Id: Semaphore.cc,v 1.2 1993/11/16 09:55:44 ngdp Exp $";
...
Boolean Semaphore::semCreate ()
{
	...
	if ((semId = ::semget(semKey, 1, 0666 | IPC_CREAT | IPC_EXCL)) != -1)
	{
		...
		error_stream << WARNING
			     << "Initialise of semaphore failed" << endl;
	}
	else
	{
	    if ((::errno == EEXIST) &&
