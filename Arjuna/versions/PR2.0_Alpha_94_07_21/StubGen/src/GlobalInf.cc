 ...
 * UK.
 *
 * $Id: GlobalInf.cc,v 1.25 1993/11/02 12:36:59 ngdp Exp $
 */
...
static const char RCSid[] = "$Id: GlobalInf.cc,v 1.25 1993/11/02 12:36:59 ngdp Exp $";
...
String GlobalInfo::version("Arjuna Stub Generator Version 3.0 alpha8 - $Date: 1993/11/02 12:36:59 $");
