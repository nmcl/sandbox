 ...
 * UK.
 *
 * $Id: Buffer.cc,v 1.2 1993/11/16 09:55:05 ngdp Exp $
 */
...
static const char RCSid[] = "$Id: Buffer.cc,v 1.2 1993/11/16 09:55:05 ngdp Exp $";
...
Boolean Buffer::pack ( const unsigned long l )
{
    ...
    // removed htonl for local MSDOS and OS/2

    *((unsigned long *) packPoint) = l;
...
Boolean Buffer::unpack ( unsigned long& l )
{
	...
	{
    // removed ntohl for local MSDOS and OS/2
...
{
	// changed size_t to long for MSDOS and OS/2
