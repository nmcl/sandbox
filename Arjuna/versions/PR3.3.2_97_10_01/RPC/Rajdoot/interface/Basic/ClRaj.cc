...
/*
 * $Id: ClRaj.cc,v 1.20.6.1 1996/10/10 12:26:10 ngdp Exp $
 */

static const char RCSid[] = "$Id: ClRaj.cc,v 1.20.6.1 1996/10/10 12:26:10 ngdp Exp $";
...
RPC_Status ClientRajdoot_rpc::initiate ()
{
	...
	else
	{
		...
		{
			error_stream << WARNING << "ClientRajdoot_rpc::initiate () : parameter errors." << endl;
