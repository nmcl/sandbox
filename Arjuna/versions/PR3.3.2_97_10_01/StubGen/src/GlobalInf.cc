 ...
 * UK.
 *
 * $Id: GlobalInf.cc,v 1.22.6.1 1996/10/10 12:26:58 ngdp Exp $
 */
...
static const char RCSid[] = "$Id: GlobalInf.cc,v 1.22.6.1 1996/10/10 12:26:58 ngdp Exp $";
...
String GlobalInfo::version("Arjuna Stub Generator Version 5.5.3 - $Date: 1996/10/10 12:26:58 $");
