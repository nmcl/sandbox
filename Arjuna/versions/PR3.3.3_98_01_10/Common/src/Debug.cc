 ...
 * UK.
 *
 * $Id: Debug.cc,v 1.8.6.1 1996/10/10 12:25:37 ngdp Exp $
 */
...
static const char RCSid[] = "$Id: Debug.cc,v 1.8.6.1 1996/10/10 12:25:37 ngdp Exp $";
...
#ifndef WIN32 // cannot do this on NT as the stream is gone by this time.
