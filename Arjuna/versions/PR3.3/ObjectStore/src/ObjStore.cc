 ...
 * UK.
 *
 * $Id: ObjStore.cc,v 1.29 1996/12/17 18:03:08 nmcl Exp $
 */
...
static const char RCSid[] = "$Id: ObjStore.cc,v 1.29 1996/12/17 18:03:08 nmcl Exp $";
				   ...
				   const char* locationOfStore )
{
    ...
    error_stream << WARNING << "Cannot find " << name << " object store."
...
Boolean ObjectStore::reference ( ObjectStore* toRef )
{
    ...
    error_stream << FATAL << "Cannot find " << toRef->type() << " object store."
		 << "\n#include RemoteOSTypes.h or LocalOSTypes.h" << endl;
...
ostream& operator<< (ostream& strm, const ObjectStore::StateStatus res)
{
    switch (res)
    {
    case ObjectStore::OS_UNKNOWN:
	strm << "ObjectStore::OS_UNKNOWN";
	break;
    case ObjectStore::OS_COMMITTED:
	strm << "ObjectStore::OS_COMMITTED";
	break;
    case ObjectStore::OS_UNCOMMITTED:
	strm << "ObjectStore::OS_UNCOMMITTED";
	break;
    case ObjectStore::OS_HIDDEN:
	strm << "ObjectStore::OS_HIDDEN";
	break;
    case ObjectStore::OS_COMMITTED_HIDDEN:
	strm << "ObjectStore::OS_COMMITTED_HIDDEN";
	break;
    case ObjectStore::OS_UNCOMMITTED_HIDDEN:
	strm << "ObjectStore::OS_UNCOMMITTED_HIDDEN";
	break;
    }
