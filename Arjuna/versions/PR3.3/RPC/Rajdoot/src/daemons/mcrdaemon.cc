...
/*
 * $Id: mcrdaemon.cc,v 1.4 1994/12/09 11:38:39 ngdp Exp $
 */
...
static const char RCSid[] = "$Id: mcrdaemon.cc,v 1.4 1994/12/09 11:38:39 ngdp Exp $";
