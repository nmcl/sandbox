...
/*
 * $Id: rpc.h,v 1.23 1996/10/09 13:11:48 nmcl Exp $
 */
...
#define USLEEPWAIT    200000   /* Time to sleep in microseconds when trying to get shared memory lock. */
#define MAXWAITTIME  1000000   /* Maximum time to wait. */
#define EXP_VALUE        2.0   /* Value to multiply usleep by if we cannot get lock. */
...
#define IDLE_TO         60000     /* Idle Time Out (10 mins - 60000) getwork() */
...
#define ROUNDTRIP_TIME    200     /* Approx roundtrip time in centi-seconds for ipc */
#define GWRETRY            10     /* Number of retries internal to initiate() */
#define SERVERRETRY        10     /* To prod a server to initialise */
#else
...
#define FILESRETRY     10      /* To open, lock, close, read and write to clist */
...
#define W_ARGS  (NSTATION * 2) + 22  /* Max. No. of arguments to activate worker */
#define SERVER_ARGS    11            /* Number of args to init_server */
...
#define NSTATION           5    /* Max. depth of a remote call */ 
#define MAXSERVERS        80    /* Max. No. of servers per node */
#define MAXCLIENTS       200    /* Max. No. of clients per server */
