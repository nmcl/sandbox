...
/*
 * $Id: manager_mode.cc,v 1.2 1994/11/10 13:47:58 nsmw Exp $
 */
...
int main (int argc, char** argv)
{
	...
	if (::strcmp(argv[i], "-multiuser") == 0)
	    request_code = MULTIUSER;
	if (::strcmp(argv[i], "-singleuser") == 0)
	    request_code = SINGLEUSER;
    ...
    actid.type = actid.hi_part = actid.lo_part = PRIORITYACTID;
	...
	cout << "Manager now in " << ((request_code == MULTIUSER) ? "multi-user" : "single-user") << " mode" << endl;
	return 0;
    }
