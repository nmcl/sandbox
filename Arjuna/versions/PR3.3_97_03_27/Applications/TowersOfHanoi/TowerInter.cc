...
/*
 * $Id: TowerInter.cc,v 1.2 1994/10/31 13:34:30 nsmw Exp $
 */
...
{
    lightgray = new Pattern(Pattern::lightgray);
    Resource::ref(lightgray);
    gray      = new Pattern(Pattern::gray);
    Resource::ref(gray);
    solid     = new Pattern(Pattern::solid);
    Resource::ref(solid);

    black = WidgetKit::instance()->foreground();
    Resource::ref(black);
    white = WidgetKit::instance()->background();
    Resource::ref(white);
