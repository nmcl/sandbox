 ...
 * UK.
 *
 * $Id: GlobalInf.cc,v 1.23 1996/09/10 15:38:44 ngdp Exp $
 */
...
static const char RCSid[] = "$Id: GlobalInf.cc,v 1.23 1996/09/10 15:38:44 ngdp Exp $";
...
String GlobalInfo::version("Arjuna Stub Generator Version 5.5.3 - $Date: 1996/09/10 15:38:44 $");
