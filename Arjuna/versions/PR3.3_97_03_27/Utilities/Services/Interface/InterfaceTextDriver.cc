 ...
 * UK.
 *
 * $Id: InterfaceTextDriver.cc,v 1.7 1995/02/22 14:56:14 ngdp Exp $
 */
...
int main(int argc, char** argv)
{
	...
	case 1: cout << "What is the interface description?\n";
		...
		cin.getline(where, 200);
		{
		    ...
		    buff.packMappedString(name);
		    buff.packMappedString(where);
		    buff.packMappedString("dummy");
		    buff.pack(0);
		...
		cin.getline(placement, 100);
		    ...
		    buff1.packMappedString(marker->me->pathname);
		...
		buff.packMappedString(marker->me->interfaces);
		buff.packMappedString(marker->me->hostname);
		buff.packMappedString(marker->me->pathname);
		buff.packMappedString(marker->me->servers);
