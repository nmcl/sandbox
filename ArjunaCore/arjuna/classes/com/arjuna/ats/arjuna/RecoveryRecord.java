 ...
 * UK.  
 *
 * $Id: RecoveryRecord.java,v 1.3 2003/08/11 15:04:12 nmcl Exp $
 */
...
public int nestedAbort ()
	...
	if (state != null)
	{
		...
		return (objectAddr.restore_state(oldState, ObjectType.RECOVERABLE) ? TwoPhaseOutcome.FINISH_OK : TwoPhaseOutcome.FINISH_ERROR);
	    }
	}
