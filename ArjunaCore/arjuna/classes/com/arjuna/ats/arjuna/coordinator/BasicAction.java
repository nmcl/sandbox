 ...
 * UK.  
 *
 * $Id: BasicAction.java,v 1.6 2003/08/11 15:04:14 nmcl Exp $
 */
 ...
 * @version $Id: BasicAction.java,v 1.6 2003/08/11 15:04:14 nmcl Exp $
 * @since JTS 1.0.
 *
 *
 * 
 ...
 * @message com.arjuna.ats.arjuna.coordinator.BasicAction_4 [com.arjuna.ats.arjuna.coordinator.BasicAction_4] - The {0} licence only allows a single resource to be registered. Please apply for a new licence.
 ...
 * @message com.arjuna.ats.arjuna.coordinator.BasicAction_9 [com.arjuna.ats.arjuna.coordinator.BasicAction_9] - \
BasicAction::removeChildThread () action {0} removing {1} result = {2}
 ...
 * @message com.arjuna.ats.arjuna.coordinator.BasicAction_29 [com.arjuna.ats.arjuna.coordinator.BasicAction_29] - BasicAction.Begin of action {0} ignored - incorrect invocation sequence
 ...
 * @message com.arjuna.ats.arjuna.coordinator.BasicAction_32 [com.arjuna.ats.arjuna.coordinator.BasicAction_32] - The {0} licence does not permit any further transactions to be committed!
 * @message com.arjuna.ats.arjuna.coordinator.BasicAction_33 [com.arjuna.ats.arjuna.coordinator.BasicAction_33] - End called on non-running atomic action 
 * @message com.arjuna.ats.arjuna.coordinator.BasicAction_34 [com.arjuna.ats.arjuna.coordinator.BasicAction_34] - End called on already committed atomic action
 * @message com.arjuna.ats.arjuna.coordinator.BasicAction_35 [com.arjuna.ats.arjuna.coordinator.BasicAction_35] - End called illegally on atomic action 
 ...
 * @message com.arjuna.ats.arjuna.coordinator.BasicAction_39 [com.arjuna.ats.arjuna.coordinator.BasicAction_39] - Abort called on non-running atomic action 
 * @message com.arjuna.ats.arjuna.coordinator.BasicAction_40 [com.arjuna.ats.arjuna.coordinator.BasicAction_40] - Abort called on already aborted atomic action 
 * @message com.arjuna.ats.arjuna.coordinator.BasicAction_41 [com.arjuna.ats.arjuna.coordinator.BasicAction_41] - Abort called illegaly on atomic action 
 ...
 * @message com.arjuna.ats.arjuna.coordinator.BasicAction_55 [com.arjuna.ats.arjuna.coordinator.BasicAction_55] - Top-level abort of action {0} received {1} from {2}
 ...
 * @message com.arjuna.ats.arjuna.coordinator.BasicAction_63 [com.arjuna.ats.arjuna.coordinator.BasicAction_63] - BasicAction::removeAllChildThreads () action {0} removing {t}
...
public BasicAction (Uid objUid)
	...
	if (tsLogger.arjLogger.debugAllowed())
	{
	    tsLogger.arjLogger.debug(DebugLevel.CONSTRUCTORS, VisibilityLevel.VIS_PUBLIC,
				     FacilityCode.FAC_ATOMIC_ACTION, 
				     "BasicAction::BasicAction("+objUid+")");
	}
...
public void finalize ()
	...
	if ((actionStatus == ActionStatus.RUNNING) || (actionStatus == ActionStatus.ABORT_ONLY))
	{
		...
		if (currentAct.isAncestor(get_uid()))
		{
		    ...
		    {
			tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_1",
						    new Object[]{get_uid()});
		    }
			...
			if (tsLogger.arjLoggerI18N.isWarnEnabled())
			{
			    tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_2",
							new Object[]{currentAct.get_uid()});
			}
	    ...
	    if (tsLogger.arjLoggerI18N.isWarnEnabled())
	    {
		tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_3", 
					    new Object[]{get_uid()});
	    }
...
public final synchronized int add (AbstractRecord A)
	     ...
	     !(recordBeingHandled.equals(A))))
	{
		...
		if (!BasicAction._ticilDone)
		{
		    try
		    {
			TxControl.onePhaseRestriction = !com.arjuna.ats.internal.arjuna.common.Lector.confirm(com.arjuna.ats.internal.arjuna.common.LicenceType.COMMIT_TWO_PHASE);
			...
			TxControl.restrictedNumberOfTwoPhaseTransactions = !com.arjuna.ats.internal.arjuna.common.Lector.confirm(com.arjuna.ats.internal.arjuna.common.LicenceType.UNLIMITED_TWO_PHASE_TRANSACTIONS);

			TxControl.restrictedNumberOfOnePhaseTransactions = !com.arjuna.ats.internal.arjuna.common.Lector.confirm(com.arjuna.ats.internal.arjuna.common.LicenceType.UNLIMITED_ONE_PHASE_TRANSACTIONS);
		...
		if (TxControl.onePhaseRestriction && (pendingList.size() == 1))
		{
		    if (tsLogger.arjLoggerI18N.isFatalEnabled())
			tsLogger.arjLoggerI18N.fatal("com.arjuna.ats.arjuna.coordinator.BasicAction_4", new Object[] { com.arjuna.ats.internal.arjuna.common.ArjunaLicenceControl.product() } );
		    
		    if (!preventCommit())  // just in case!
			throw new LicenceError(tsLogger.log_mesg.getString("com.arjuna.ats.arjuna.coordinator.BasicAction_4"));
		}
	    }
...
public synchronized boolean activate (String root)
	...
	if (tsLogger.arjLogger.debugAllowed())
	{
	    tsLogger.arjLogger.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
				     FacilityCode.FAC_ATOMIC_ACTION, 
				     "BasicAction::activate() for action-id "+get_uid());
	}
	...
	try
	{
		...
		if (tsLogger.arjLoggerI18N.isWarnEnabled())
		{
		    tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_5",
						new Object[]{get_uid(), type()} );
		}
...
public final synchronized boolean addChildThread (Thread t)
	...
	if (tsLogger.arjLoggerI18N.debugAllowed())
	{
	    tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					 ...
					 new Object[]{get_uid(), t, new Boolean(result)});
	}
...
public final synchronized boolean removeChildThread (String threadId)
	...
	if (tsLogger.arjLoggerI18N.debugAllowed())
	{
		...
		tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					     ...
					     new Object[]{get_uid(), threadId, "true"});
	    else 
		tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					     FacilityCode.FAC_ATOMIC_ACTION, 
					     "com.arjuna.ats.arjuna.coordinator.BasicAction_9", 
					     new Object[]{get_uid(), threadId, "false"});
	}
...
public final synchronized boolean addChildAction (BasicAction act)
	...
	if (tsLogger.arjLoggerI18N.debugAllowed())
	{
	    tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC, 
					 ...
					 new Object[]{get_uid(), ((act != null) ? act.get_uid() : Uid.nullUid())});
	}
	...
	if (tsLogger.arjLoggerI18N.debugAllowed())
	{
	    if (result)
		    tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
						 ...
						 new Object[]{get_uid(),act.get_uid(),"true"});
		else
		    tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
						 FacilityCode.FAC_ATOMIC_ACTION, 
						 "com.arjuna.ats.arjuna.coordinator.BasicAction_11", 
						 new Object[]{get_uid(),act.get_uid(),"false"});
	}
	...
	while ((res) && (temp != null))
	{
		...
		if (temp.doSave())
		    tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
						 ...
						 new Object[]{Integer.toString(temp.typeIs()),temp.type(),"true"});
		else 
		    tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
						 FacilityCode.FAC_ATOMIC_ACTION, 
						 "com.arjuna.ats.arjuna.coordinator.BasicAction_14", 
						 new Object[]{Integer.toString(temp.typeIs()),temp.type(),"false"});
	    }
		...
		try
		{
			...
			tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
						     FacilityCode.FAC_ATOMIC_ACTION, 
						     "com.arjuna.ats.arjuna.coordinator.BasicAction_15", 
						     new Object[]{Integer.toString(temp.typeIs())});
		    }
	...
	if (res && (os.notempty() || !havePacked))
	{
		...
		if (tsLogger.arjLoggerI18N.debugAllowed())
		{
		    tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, 
						 ...
						 FacilityCode.FAC_ATOMIC_ACTION, 
						 "com.arjuna.ats.arjuna.coordinator.BasicAction_16");
		}
		...
		while (res && (temp != null))
		{
			...
			try
			{
				...
				tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, 
							     VisibilityLevel.VIS_PUBLIC,
							     FacilityCode.FAC_ATOMIC_ACTION, 
							     "com.arjuna.ats.arjuna.coordinator.BasicAction_17", 
							     new Object[]{Integer.toString(temp.typeIs())});
			    }
		...
		if (res && os.notempty())
		{
			...
			if (tsLogger.arjLoggerI18N.debugAllowed())
			{
			    tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, 
							 VisibilityLevel.VIS_PUBLIC,
							 FacilityCode.FAC_ATOMIC_ACTION, 
							 "com.arjuna.ats.arjuna.coordinator.BasicAction_18");
			}
	...
	if (res && os.notempty())
	{
		...
		if (tsLogger.arjLoggerI18N.debugAllowed())
		{
		    tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, 
						 VisibilityLevel.VIS_PUBLIC,
						 FacilityCode.FAC_ATOMIC_ACTION,
						 "com.arjuna.ats.arjuna.coordinator.BasicAction_19", 
						 new Object[]{ActionStatus.printString(actionStatus)});
		}
...
public boolean restore_state (InputObjectState os, int ot)
	...
	try
	{
		...
		tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					     FacilityCode.FAC_ATOMIC_ACTION,
					     "com.arjuna.ats.arjuna.coordinator.BasicAction_20", 
					     new Object[]{Integer.toString(record_type)});
	    }
	}
	catch (IOException e)
	{
	...
	while ((res) && (record_type != RecordType.NONE_RECORD))
	{
		...
		if (tsLogger.arjLoggerI18N.isWarnEnabled())
		{
		    tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_21",
						new Object[]{Integer.toString(record_type)});
		}
	...
	if (res)
	{
		...
		if (tsLogger.arjLoggerI18N.debugAllowed())
		{
		    tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
						 FacilityCode.FAC_ATOMIC_ACTION,
						 "com.arjuna.ats.arjuna.coordinator.BasicAction_22",
						 new Object[]{Integer.toString(hSize)});    
		}
	    }
	    catch (IOException e)
	    {
	...
	if (hSize > 0)
	{
		...
		if (tsLogger.arjLoggerI18N.debugAllowed())
		{
		    tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, 
						 VisibilityLevel.VIS_PUBLIC,
						 FacilityCode.FAC_ATOMIC_ACTION,
						 "com.arjuna.ats.arjuna.coordinator.BasicAction_23", 
						 new Object[]{Integer.toString(record_type)});
		}
	    }
	    catch (IOException e)
	...
	if (res)
	{
		...
		tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					     FacilityCode.FAC_ATOMIC_ACTION,
					     "com.arjuna.ats.arjuna.coordinator.BasicAction_25", 
					     new Object[]{ActionStatus.printString(tempActionStatus), 
							  Integer.toString(tempActionStatus)});
		
		tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					     FacilityCode.FAC_ATOMIC_ACTION, 
					     "com.arjuna.ats.arjuna.coordinator.BasicAction_26", 
					     new Object[]{((tempActionType == ActionType.NESTED)?"Nested":"Top-level"), Integer.toString(tempActionType)});
		
		tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					 FacilityCode.FAC_ATOMIC_ACTION, 
					 "com.arjuna.ats.arjuna.coordinator.BasicAction_27", 
					 new Object[]{TwoPhaseOutcome.printString(tempHeuristicDecision),
...
protected synchronized int Begin (BasicAction parentAct)
	...
	if (tsLogger.arjLogger.debugAllowed())
	{
	    tsLogger.arjLogger.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PROTECTED,
				     FacilityCode.FAC_ATOMIC_ACTION, 
				     "BasicAction::Begin() for action-id "+get_uid());
	}
	...
	if (actionStatus != ActionStatus.CREATED)
	{
	    if (tsLogger.arjLoggerI18N.isWarnEnabled())
	    {
		tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_29",
					    new Object[]{get_uid()});
	    }
	}
	else
	{
		...
		if (parentAct == null)
		{
		    if (tsLogger.arjLoggerI18N.isWarnEnabled())
		    {
			tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_30",
						    new Object[]{get_uid()});
		    }
		}
		else
		{
		    if (tsLogger.arjLoggerI18N.debugAllowed())
		    {
			tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_31",
						    new Object[]{get_uid(), parentAct.get_uid(),
...
protected synchronized int End (boolean reportHeuristics)
	...
	if (tsLogger.arjLogger.debugAllowed())
	{
	    tsLogger.arjLogger.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PROTECTED,
				     FacilityCode.FAC_ATOMIC_ACTION, 
				     "BasicAction::End() for action-id "+get_uid());
	}
	
	if (TxControl.restrictedNumberOfTwoPhaseTransactions ||
	    TxControl.restrictedNumberOfOnePhaseTransactions)
	    {
		boolean problem = true;
		
		if (TxControl.onePhaseRestriction &&
		    !TxControl.restrictedNumberOfOnePhaseTransactions)
		{
		...
		if (problem && (TxControl.numberOfTransactions-- <= 0))
		{
		    actionStatus = ActionStatus.ABORT_ONLY;
		    TxControl.numberOfTransactions = 0;

		    if (tsLogger.arjLoggerI18N.isFatalEnabled())
			tsLogger.arjLoggerI18N.fatal("com.arjuna.ats.arjuna.coordinator.BasicAction_32", new Object[] { com.arjuna.ats.internal.arjuna.common.ArjunaLicenceControl.product() } );
		}
	    }
	...
	if ((actionStatus != ActionStatus.RUNNING) && (actionStatus != ActionStatus.ABORT_ONLY))
	{
		...
		case ActionStatus.CREATED:
		    tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_33");
		    break;
		case ActionStatus.COMMITTED:
		    tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_34");
		    break;
		default:
		    tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_35");
		    break;
		}

		tsLogger.arjLoggerI18N.warn(get_uid().stringForm());
	    }
	...
	if (pendingList != null)
	{
		...
		if (prepare(reportHeuristics) == TwoPhaseOutcome.PREPARE_NOTOK)
		{
		    if (tsLogger.arjLoggerI18N.isWarnEnabled())
		    {
			tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_36",
						    new Object[]{get_uid()});
		    }
			...
			if (tsLogger.arjLoggerI18N.isWarnEnabled())
			{
			    tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_37", 
							new Object[]{TwoPhaseOutcome.printString(heuristicDecision)});
			}
		    }
...
protected synchronized int Abort ()
	...
	if (tsLogger.arjLogger.isDebugEnabled())
	{
	    tsLogger.arjLogger.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PROTECTED,
				     FacilityCode.FAC_ATOMIC_ACTION, 
				     "BasicAction::Abort() for action-id "+get_uid());
	}
	...
	if ((actionStatus != ActionStatus.RUNNING) && (actionStatus != ActionStatus.ABORT_ONLY))
	{
		...
		{
		case ActionStatus.CREATED:
		    tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_39");
		    break;
		case ActionStatus.ABORTED:
		    tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_40");
		    break;
		default:
		    tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_41");
		    break;
		}
	...
	/*
	 * Check we are the current action. Abort parents if not true.
	 * Some implementations may want to override this.
	 */
...
protected final synchronized void phase2Cleanup ()
	...
	if (tsLogger.arjLogger.isDebugEnabled())
	{
	    tsLogger.arjLogger.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PROTECTED,
				     FacilityCode.FAC_ATOMIC_ACTION, 
				     "BasicAction::phase2Cleanup() for action-id "+get_uid());
	}
	...
	if (tsLogger.arjLogger.debugAllowed())
	{
	    tsLogger.arjLogger.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PROTECTED,
				     FacilityCode.FAC_ATOMIC_ACTION, 
				     "BasicAction::phase2Commit() for action-id "+get_uid());
	}
	...
	if ((pendingList == null) || (pendingList.size() > 0))
	{
	    if (tsLogger.arjLoggerI18N.isWarnEnabled())
	    {
		tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_42", 
					    new Object[]{get_uid(), Integer.toString(pendingList.size()),
							 pendingList});
	    }
     ...
     * prepare() stops processing the list at the first PREPARE_NOTOK result.
     *
     * By default, records that responsed PREPARE_READONLY will not be
     * contacted during second-phase abort, just as they are not during
     * second-phase commit. This can be overridden at runtime using the
	...
	if (tsLogger.arjLogger.debugAllowed())
	{
	    tsLogger.arjLogger.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PROTECTED,
				     FacilityCode.FAC_ATOMIC_ACTION, 
				     "BasicAction::phase2Abort() for action-id "+get_uid());
	}
     ...
     * If all goes well it will be PREPARE_OK, if not PREPARE_NOTOK.
     * The value PREPARE_READONLY may also be returned if all the records indicate
...
protected synchronized final int prepare (boolean reportHeuristics)
	...
	if (tsLogger.arjLogger.debugAllowed())
	{
	    tsLogger.arjLogger.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PROTECTED,
				     FacilityCode.FAC_ATOMIC_ACTION, 
				     "BasicAction::prepare () for action-id "+get_uid());
	}
	...
	if (!commitAllowed)
	{
	    if (tsLogger.arjLoggerI18N.isWarnEnabled())
	    {
		tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_43", 
					    new Object[]{get_uid()});
	    }
	...
	if ((actionType == ActionType.TOP_LEVEL) && (TxControl.asyncPrepare))
	{
	    ...
	    /*
	     * If one of these threads fails (PREPARE_NOTOK) do we
		...
		while (threads[j].isAlive())
		{
			...
			if (tsLogger.arjLogger.isWarnEnabled())
			{
			    tsLogger.arjLogger.warn("BasicAction.prepare - "+e);
			}
	    ...
	    (p != TwoPhaseOutcome.PREPARE_READONLY))
	{
	    ...
	    {
		/*
		 * For the OTS we must merge those records told to commit
		 * with the parent, as the rollback invocation must come from
		 * that since they have already been told this transaction has
		 * committed!
		 */
	 ...
	 *
	 * (ii) if we are an interposed transaction and it receives
	    ...
	    ((preparedList.size() > 0) || (heuristicList.size() > 0)))
	{
		...
		if (tsLogger.arjLoggerI18N.isWarnEnabled())
		{
		    tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_45",
						new Object[]{get_uid()});
		}
		...
		try
		{
			...
			if (tsLogger.arjLoggerI18N.isWarnEnabled())
			{
			    tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_46",
							new Object[]{get_uid()});
			}
...
protected void onePhaseCommit (boolean reportHeuristics)
	...
	if (tsLogger.arjLogger.isDebugEnabled())
	{
	    tsLogger.arjLogger.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PROTECTED,
				     FacilityCode.FAC_ATOMIC_ACTION, 
				     "BasicAction::onePhaseCommit() for action-id "+get_uid());
	}
	...
	else
	{
		...
		if (tsLogger.arjLoggerI18N.isWarnEnabled())
		{
		    tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_47",
						new Object[]{get_uid(), TwoPhaseOutcome.printString(p)});
		}
		...
		if (heuristicDecision == TwoPhaseOutcome.HEURISTIC_ROLLBACK)
		{
		    ...
		    heuristicDecision = TwoPhaseOutcome.PREPARE_OK;  // means no heuristic was raised.
	...
	if (actionType == ActionType.TOP_LEVEL)
	{
		...
		if (store() == null)
		{
		    ...
		    throw new com.arjuna.ats.arjuna.exceptions.FatalError(tsLogger.log_mesg.getString("com.arjuna.ats.arjuna.coordinator.BasicAction_69")+get_uid());
		}
...
protected synchronized int abortStatus ()
    {
	return ActionStatus.ABORTED;
    }

protected synchronized int commitStatus ()
    {
...
protected int doPrepare (boolean reportHeuristics) throws IndexOutOfBoundsException
	...
	do
	{
		 ...
		 * pending list. Otherwise it is moved to another list or dropped
		 * if readonly.
		 */
	...
	} while ((p == TwoPhaseOutcome.PREPARE_OK) || (p == TwoPhaseOutcome.PREPARE_READONLY));
	...
	if (record != null)
	{
		...
		else
		{
			...
			if (actionType == ActionType.NESTED)
			{
				...
				if (tsLogger.arjLoggerI18N.isWarnEnabled())
				{
				    tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_49", 
								new Object[]{get_uid()});
				}
				 ...
				 * something other than PREPARE_NOTOK.
				 */
			...
			if (tsLogger.arjLoggerI18N.isWarnEnabled())
			{
			    tsLogger.arjLoggerI18N.warn("BasicActtion_50", 
							new Object[]{get_uid(),
								     TwoPhaseOutcome.printString(p)});
			}
...
protected int doCommit (RecordList rl, boolean reportHeuristics)
	...
	if ((rl != null) && (rl.size() > 0))
	{
		...
		/*
		 * Check the outcome and if we have a heuristic rollback
		 * try to rollback everything else in the
		 * list *if* we have not already committed something. That
		 * way we make the outcome for all participants the same as
		 * the first (rollback) and don't get a heuristic!
		 */
		...
		default:
		     ...
		     * We've got this far as errors have caused problems, but
		     * we gain nothing by now rolling back some participants.
		     * This could cause further heuristics!
		     */
		...
		case TwoPhaseOutcome.HEURISTIC_ROLLBACK:
		    {
			/*
			 * A heuristic decision of commit means that we have
			 * got past the first entry in the list. So there is
			 * no going back now!
			 */
			...
			{
			    /*
			     * Remember the heuristic decision so we can
			     * restore it after rolling back. Otherwise we
			     * can't return the right value from commit.
			     */
...
protected int doCommit (boolean reportHeuristics, AbstractRecord record)
	...
	if (tsLogger.arjLogger.debugAllowed())
	{
	    tsLogger.arjLogger.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PRIVATE,
				     FacilityCode.FAC_ATOMIC_ACTION, "BasicAction::doCommit ("+record+")");
	}
	...
	if (recordBeingHandled != null)
	{
		...
		if ((ok = recordBeingHandled.topLevelCommit()) == TwoPhaseOutcome.FINISH_OK)
		{
		    ...
		    updateHeuristic(TwoPhaseOutcome.FINISH_OK, true);// must remember that something has committed
		}
		else
		{
		    if (tsLogger.arjLoggerI18N.debugAllowed(DebugLevel.FUNCTIONS, 
			...
			tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PRIVATE,
						     ...
						     new Object[]{get_uid(), TwoPhaseOutcome.printString(ok),
								  RecordType.typeToClassName(recordBeingHandled.typeIs())});
		    }
...
protected int doAbort (boolean reportHeuristics, AbstractRecord record)
	...
	{
	    tsLogger.arjLogger.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PRIVATE,
				     FacilityCode.FAC_ATOMIC_ACTION, "BasicAction::doAbort ("+record+")");
	}
	...
	{   
		...
		if (ok == TwoPhaseOutcome.FINISH_OK)
		{
		    updateHeuristic(TwoPhaseOutcome.FINISH_OK, false);  // remember that something aborted ok
		}
		else
		{
		    if ((reportHeuristics) && ((ok == TwoPhaseOutcome.HEURISTIC_ROLLBACK) ||
			...
			{
			    if (actionType == ActionType.TOP_LEVEL)
				tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_52", new Object[]{get_uid(),TwoPhaseOutcome.printString(ok)});
			    else
				tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_53", new Object[]{get_uid(),TwoPhaseOutcome.printString(ok)});
			}
			...
			if (ok != TwoPhaseOutcome.FINISH_OK)
			{
			    ...
			    {
				if (actionType == ActionType.TOP_LEVEL)
				    tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_54", new Object[]{get_uid(), TwoPhaseOutcome.printString(ok), RecordType.typeToClassName(recordBeingHandled.typeIs())});
				else
				    tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_55", new Object[]{get_uid(), TwoPhaseOutcome.printString(ok), RecordType.typeToClassName(recordBeingHandled.typeIs())});
			    }
			}
		    }
		}
...
protected AbstractRecord insertRecord (RecordList reclist, AbstractRecord record)
    ...
    /**
     * Do we want to check that a transaction can only be terminated by
     * a thread that has it as its current transaction? The base class
     * has this check enabled (i.e., we check), but some implementations may
...
protected final synchronized void updateHeuristic (int p, boolean commit)
	 ...
	 * then go with that until something better comes along!
	 */
	...
	{
	case TwoPhaseOutcome.PREPARE_OK:
	    if ((p != TwoPhaseOutcome.PREPARE_OK) && (p != TwoPhaseOutcome.FINISH_OK))   // first heuristic outcome.
		heuristicDecision = p;
	    break;
	case TwoPhaseOutcome.HEURISTIC_COMMIT:
...
private final boolean checkIsCurrent ()
	...
	if (checkForCurrent())
	{
		...
		if (tsLogger.arjLoggerI18N.isWarnEnabled())
		{
		    tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_56",
						new Object[]{currentAct.get_uid(), get_uid()});
		}
...
private final boolean checkChildren (boolean isCommit)
	...
	if ((_childThreads != null) && (_childThreads.size() > 0))
	{
		...
		if (tsLogger.arjLoggerI18N.isWarnEnabled())
		{
		    if (isCommit)
		    {
			tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_57", 
						    new Object[]{get_uid()});
		    }
		    else
		    {
			tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_58", 
						    new Object[]{get_uid()});
		    }
		}
	...
	if ((_childActions != null) && (_childActions.size() > 0))
	{
		...
		if (child.status() != ActionStatus.ABORTED)
		{
			...
			if (tsLogger.arjLoggerI18N.isWarnEnabled())
			{
			    if (isCommit)
			    {
				tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_59", 
							    new Object[]{get_uid()});
			    }
			    else
			    {
				tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_60", 
							    new Object[]{get_uid()});
			    }
			}
		    ...
		    if (tsLogger.arjLoggerI18N.isWarnEnabled())
		    {
			tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_61", 
						    new Object[]{child.get_uid()});
		    }
		...
		if (tsLogger.arjLoggerI18N.isWarnEnabled())
		{
		    tsLogger.arjLoggerI18N.warn("com.arjuna.ats.arjuna.coordinator.BasicAction_62", 
						new Object[]{child.get_uid()});
		}
...
private final void updateState ()
	...
	if (tsLogger.arjLogger.isDebugEnabled())
	{
	    tsLogger.arjLogger.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PRIVATE,
				     FacilityCode.FAC_ATOMIC_ACTION, 
				     "BasicAction::updateState() for action-id "+get_uid());
	}
	...
	if (tsLogger.arjLogger.isDebugEnabled())
	{
	    tsLogger.arjLogger.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PRIVATE, 
				     FacilityCode.FAC_ATOMIC_ACTION, 
				     "BasicAction::actionInitialise() for action-id "+get_uid());
	}
	...
	if (parent != null)		/* ie not top_level */
	{
		...
		tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PRIVATE, 
					     FacilityCode.FAC_ATOMIC_ACTION, 
					     "com.arjuna.ats.arjuna.coordinator.BasicAction_66", 
					     new Object[]{get_uid(),Integer.toString(parent.actionStatus)}); 
	    }
	...
	case ActionType.TOP_LEVEL:
		...
		if (tsLogger.arjLoggerI18N.debugAllowed())
		{
		    tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PRIVATE, 
						 FacilityCode.FAC_ATOMIC_ACTION, 
						 "com.arjuna.ats.arjuna.coordinator.BasicAction_67", 
						 new Object[]{get_uid(), parent.get_uid()});
		}
	    }
	    break;
...
private final void doForget (RecordList list_toprocess)
	...
	if (tsLogger.arjLogger.isDebugEnabled())
	{
	    tsLogger.arjLogger.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PRIVATE,
				     FacilityCode.FAC_ATOMIC_ACTION, 
				     "BasicAction::doForget ("+list_toprocess+")");
	}
	...
	if (!TxControl.maintainHeuristics)
	{
...
private final void doCleanup (RecordList list_toprocess)
	...
	if (tsLogger.arjLogger.isDebugEnabled())
	{
	    tsLogger.arjLogger.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PRIVATE,
				     FacilityCode.FAC_ATOMIC_ACTION, 
				     "BasicAction::doCleanup ("+list_toprocess+")");
	}
