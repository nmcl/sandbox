 ...
 * UK.  
 *
 * $Id: RecordList.java,v 1.3 2003/08/11 15:04:14 nmcl Exp $
 */
 ...
 * @version $Id: RecordList.java,v 1.3 2003/08/11 15:04:14 nmcl Exp $
 * @since JTS 1.0.
 *
...
private final boolean insert (AbstractRecord newRecord, AbstractRecord startAt)
	...
	while (current != null)
	{
		...
		if (tsLogger.arjLoggerI18N.debugAllowed())
		{
		    tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PRIVATE,
						 FacilityCode.FAC_ABSTRACT_REC, "RecordList_1", 
		...
		if (newRecord.shouldReplace(current))
		{
		    ...
		    {
			tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PRIVATE,
						     FacilityCode.FAC_ABSTRACT_REC, "RecordList_2", 
		...
		else
		{
			...
			{
			    tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PRIVATE,
							 FacilityCode.FAC_ABSTRACT_REC, "RecordList_3", 
							 new Object[]{this, newRecord.type(),
								      current.type(), newRecord.order()});
			}
			...
			else if (newRecord.lessThan(current))
			{
			    ...
			    {
				tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PRIVATE,
							     FacilityCode.FAC_ABSTRACT_REC, "RecordList_4",
							     new Object[]{this, newRecord.type(),
	...
	if (current == null)
	{
		...
		tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PRIVATE,
					     ...
					     "RecordList_5",new Object[]{this,newRecord.type(),newRecord.order()});
	    }
	...
	else
	{
		...
		tsLogger.arjLoggerI18N.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PRIVATE,
					     FacilityCode.FAC_ABSTRACT_REC, 
					     "RecordList_6", new Object[]{this, newRecord.type(),newRecord.order(),
