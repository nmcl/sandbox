 ...
 * UK.  
 *
 * $Id: ShadowingStore.java,v 1.3 2003/08/11 15:04:19 nmcl Exp $
 */
 ...
 * @version $Id: ShadowingStore.java,v 1.3 2003/08/11 15:04:19 nmcl Exp $
 * @since 1.0
 */
 ...
 * @message com.arjuna.ats.internal.arjuna.objectstore.ShadowingStore_14 [com.arjuna.ats.internal.arjuna.objectstore.ShadowingStore_14] - unknown
 * @message com.arjuna.ats.internal.arjuna.objectstore.ShadowingStore_15 [com.arjuna.ats.internal.arjuna.objectstore.ShadowingStore_15] - hidden
...
protected boolean remove_state (Uid objUid, String name, int ft) throws ObjectStoreException
	...
	if (name != null)
	{
		...
		if (state == ObjectStore.OS_UNKNOWN)
		    tsLogger.arjLoggerI18N.info("com.arjuna.ats.internal.arjuna.objectstore.ShadowingStore_14");
		else
		    tsLogger.arjLoggerI18N.info("com.arjuna.ats.internal.arjuna.objectstore.ShadowingStore_15");

		tsLogger.arjLoggerI18N.info("com.arjuna.ats.internal.arjuna.objectstore.ShadowingStore_16", 
					    new Object[]{objUid, name});
	    }
	}
	else
