 ...
 * UK.
 *
 * $Id: ExpiredTransactionStatusManagerScanner.java,v 1.3 2003/08/11 15:04:20 nmcl Exp $
 */
...
public class ExpiredTransactionStatusManagerScanner implements ExpiryScanner
{
   ...
   public void scan ()
   {
	...
	String expiryTimeString = arjPropertyManager.propertyManager.getProperty
