 ...
 * UK.
 *
 * $Id: TransactionStatusConnector.java,v 1.2 2003/08/11 14:07:44 nmcl Exp $
 */
   ...
   private boolean establishConnection()
   {
      ...
      if ( _tsmi != null )
      {
         try
         {
            ...
            _from_server = new BufferedReader ( new InputStreamReader
                              ( _connector_socket.getInputStream() )) ;
                              
            _to_server   = new PrintWriter ( new OutputStreamWriter
                              ( _connector_socket.getOutputStream() ) ) ;
		  ...
		  if (tsLogger.arjLoggerI18N.isInfoEnabled())
		  {
	       ...
	       {
		   tsLogger.arjLoggerI18N.info
		       ( "com.arjuna.ats.internal.arjuna.recovery.TransactionStatusConnector_5", new Object[]{_pid});
	       }
         ...
         _attempts_to_establish_connection = connectionEstablished ? 0 : 
             _attempts_to_establish_connection + 1 ;
