 ...
 * UK.
 *
 * $Id: LockManager.java,v 1.3 2003/08/11 15:04:48 nmcl Exp $
 */
 ...
 * @version $Id: LockManager.java,v 1.3 2003/08/11 15:04:48 nmcl Exp $
 * @since JTS 1.0.
 ...
 * @message com.arjuna.ats.txoj.LockManager_9 [com.arjuna.ats.txoj.LockManager_9] - Arjuna licence does not enable transactional objects. Please apply for a new licence.
...
private final boolean loadState ()
	...
	try
	{
	    ...
	    {
		LockManager._aitEnabled = com.arjuna.ats.internal.arjuna.common.Lector.confirm(com.arjuna.ats.internal.arjuna.common.LicenceType.TRANSACTIONAL_OBJECTS);
	...
	if (!LockManager._aitEnabled)
	{
		...
		txojLogger.aitLoggerI18N.fatal("com.arjuna.ats.txoj.LockManager_9");
		...
		throw new com.arjuna.ats.arjuna.exceptions.LicenceError("Arjuna licence does not enable transactional objects. Please apply for a new licence.");
	}
