 ...
 * UK.
 *
 * $Id: BitVector.cc,v 1.2 1998/06/02 16:50:56 nmcl Exp $
 */
...
void knuth ()
{
	...
	UniformStream stream(0, h*2, 0, h);
	unsigned long hits = 0;
...
int main (int argc, char** argv)
{
	...
	{
	    cout << "Usage: " << argv[0] << " [-bitsize <size>] [-set <number>] [-entries <number>] [-table <size>] [-random1] [-random2] [-knuth] [-help]" << endl;
	    return 0;
	}
    }
