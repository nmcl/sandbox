 ...
 * UK.
 *
 * $Id: EnumT.cc,v 1.1 1997/09/25 15:30:53 nmcl Exp $
 */
...
static const char RCSid[] = "$Id: EnumT.cc,v 1.1 1997/09/25 15:30:53 nmcl Exp $";
...
String  EnumType::preName ( DeclStyle ds , Boolean elaborated, Boolean ) const
{
    String s;
