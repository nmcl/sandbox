 ...
 * UK.
 *
 * $Id: IncludeT.cc,v 1.1 1997/09/25 15:31:05 nmcl Exp $
 */
...
static const char RCSid[] = "$Id: IncludeT.cc,v 1.1 1997/09/25 15:31:05 nmcl Exp $";
			   ...
			   noMangle(sm == STUB_NORENAME ? TRUE : FALSE)
{
    ...
    if (suf != (const char*) ".h")  // visual c++ problem!
	noMangle = TRUE;   
}
