 ...
 * UK.  
 *
 * $Id: OTM.java,v 1.1 2000/02/25 14:03:31 nmcl Exp $
 */
...
public synchronized void updateTransactions ()
	...
	if (scanningNode != null)
	{
	    ...
	    try
	    {
		ClassName actionStoreType = new ClassName(PropertyManager.getProperty(ArjunaLiteEnvironment.ACTION_STORE,
									     ArjunaLiteNames.Implementation_ObjectStore_defaultActionStore().stringForm()));
