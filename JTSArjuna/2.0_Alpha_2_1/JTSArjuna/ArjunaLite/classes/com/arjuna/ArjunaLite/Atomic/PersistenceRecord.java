 ...
 * UK.  
 *
 * $Id: PersistenceRecord.java,v 1.2 2000/03/07 09:44:44 nmcl Exp $
 */
...
public int topLevelCommit ()
	...
	{
	    System.err.println("PersistenceRecord::topLevelCommit - no object store specified!");
	}
...
public boolean save_state (OutputObjectState os, int ot)
	...
	if (store != null)
	{
	    ...
	    {
		System.err.println("PersistenceRecord::save_state - type of store is unknown");
		res = false;
	    }
	    else
	    {
		try
		{
			...
			{
			    System.err.println("PersistenceRecord::save_state - packing top level state failed\n");
			}
		    }
		}
		catch (IOException e)
	...
	{
	    System.err.println("PersistenceRecord::save_state - no object store defined for object");
