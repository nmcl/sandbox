 ...
 * UK.
 *
 * $Id: OTS_ContextFilter.java,v 1.3.4.1.2.1.2.3 2000/06/01 12:43:58 nmcl Exp $
 */
...
public void outReplyFailure (Request r, Exception ex)
	...
	{
	    System.err.println("WARNING - OTS_ContextFilter::outReplyPreMarshal caught: "+e1);
	}
	catch (Exception e2)
	{
	    System.err.println("WARNING - OTS_ContextFilter::outReplyPreMarshal caught exception: "+e2);
	}
    }
