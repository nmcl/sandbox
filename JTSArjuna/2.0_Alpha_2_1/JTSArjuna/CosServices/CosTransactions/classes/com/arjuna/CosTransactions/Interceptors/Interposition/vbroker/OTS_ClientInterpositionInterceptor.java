 ...
 * UK.
 *
 * $Id: OTS_ClientInterpositionInterceptor.java,v 1.1 2000/02/25 14:06:12 nmcl Exp $
 */
...
public void preinvoke_postmarshal (org.omg.CORBA.Object target,
	...
	else
	{
		...
		{
		    System.err.println("OTS_ClientInterpositionInterceptor.preinvoke_postmarshal - caught unexpected exception: "+e);
		}
		catch (Unavailable e)
		{
		    System.err.println("OTS_ClientInterpositionInterceptor.preinvoke_postmarshal - caught Inactive exception: "+e);
...
private boolean packPropagationContext (CDROutputStream ostr,
	...
	else
	{
	    ...
	    {
		System.err.println("WARNING OTS_ClientInterpositionInterceptor.packPropagationContext caught exception: "+e);
