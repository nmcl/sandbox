 ...
 * UK.  
 *
 * $Id: OTS_ServerInterpositionInterceptor.java,v 1.1 2000/02/25 14:06:14 nmcl Exp $
 */
...
public void preinvoke (org.omg.CORBA.Object target, String operation,
	...
	else
	{
		...
		if (ctx != null)
		{
		    ...
		    {
			System.err.println("OTS_ServerInterpositionInterceptor received transaction context but could not deal with it!");
	    ...
	    {
		System.err.println("OTS_ServerInterpositionInterceptor.preinvoke - caught InvalidControl: "+e1);
	    }
	    catch (SystemException e2)
	    {
		System.err.println("OTS_ServerInterpositionInterceptor.preinvoke - caught unexpected exception: "+e2);
		e2.printStackTrace();
	    }
...
private PropagationContext unpackPropagationContext (CDRInputStream istr,
	...
	if (haveContext && fullUnpack)
	{
	    ...
	    {
		System.err.println("WARNING OTS_ServerInterpositionInterceptor.unpackPropagationContext caught exception: "+e);
		ctx = null;
	    }
	}
