@echo off
rem
rem JTSArjuna-2.0 setup script
rem
...
set CLASSPATH=%CLASSPATH%;%JTSARJUNA_HOME%\lib\ArjunaLite.jar;%JTSARJUNA_HOME%\lib\JTS.jar;%JTSARJUNA_HOME%\lib\ArjunaCommon.jar;%JTSARJUNA_HOME%\lib\JTSArjuna.jar;%JTSARJUNA_HOME%\lib\OrbCommon.jar;%JTSARJUNA_HOME%\lib\JDBCArjuna.jar;%JTSARJUNA_HOME%\lib\JDBC2Arjuna.jar;%JTSARJUNA_HOME%\lib\JTSArjunaInfo.jar;%JTSARJUNA_HOME%\lib\JavaHarness.jar;.
