 ...
 * UK.  
 *
 * $Id: LocalSetup.java,v 1.1.2.1 2000/04/25 08:36:26 nmcl Exp $
 */
...
public void initialise (String[] params)
	...
	for (int i = 0; i < params.length; i++)
	{
		...
		if ((propertyName.compareTo(ORBEnvironment.INITIAL_REFERENCES_ROOT) == 0) ||
		    (propertyName.compareTo(ORBEnvironment.INITIAL_REFERENCES_FILE) == 0) ||
		    (propertyName.compareTo(ORBEnvironment.FILE_DIR) == 0))
		{
		    setProperty = true;
		}
