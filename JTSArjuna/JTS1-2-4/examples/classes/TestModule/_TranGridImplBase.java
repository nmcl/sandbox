...
//
public abstract class _TranGridImplBase extends org.omg.CORBA.DynamicImplementation
                                        implements TranGrid
{
    ...
    _OB_op_set(org.omg.CORBA.ServerRequest _ob_req)
    {
        ...
        _ob_aa1.type(_orb().get_primitive_tc(org.omg.CORBA.TCKind.tk_short));
        _ob_list.add_value("", _ob_aa1, org.omg.CORBA.ARG_IN.value);
        org.omg.CORBA.Any _ob_aa2 = _orb().create_any();
        _ob_aa2.type(_orb().get_primitive_tc(org.omg.CORBA.TCKind.tk_short));
        _ob_list.add_value("", _ob_aa2, org.omg.CORBA.ARG_IN.value);
        _ob_req.params(_ob_list);

        short _ob_a0 = _ob_aa0.extract_short();
        short _ob_a1 = _ob_aa1.extract_short();
        short _ob_a2 = _ob_aa2.extract_short();

        set(_ob_a0, _ob_a1, _ob_a2);
    }
