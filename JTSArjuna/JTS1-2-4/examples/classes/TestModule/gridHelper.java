...
{
    public static void
    insert(org.omg.CORBA.Any any, grid val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "grid");
        }
    ...
    id()
    {
        return "IDL:/TestModule/grid:1.0";
    }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        StubForgrid stub = new StubForgrid();
        stub._set_delegate(impl._get_delegate());
        return stub;
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, grid val)
    {
