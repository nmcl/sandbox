 ...
 * UK.
 *
 * $Id: LocalSetup.java,v 1.1 1998/11/12 08:52:34 nmcl Exp $
 */
...
public void initialise (String[] params)
	...
	for (int i = 0; i < params.length; i++)
	{
		...
		if ((propertyName.compareTo(environment.CONFIGURATION_ROOT) == 0) ||
		    (propertyName.compareTo(environment.CONFIGURATION_FILE) == 0) ||
