 ...
 * UK.
 *
 * $Id: OTM.java,v 1.7 1999/06/18 14:18:28 nmcl Exp $
 */
...
public synchronized void updateTransactions ()
	...
	if (scanningNode != null)
	{
	    ...
	    try
	    {
		ClassName actionStoreType = new ClassName(System.getProperty(JavaArjunaLiteNames.BasicAction_actionStore(),
									     JavaArjunaLiteNames.Implementation_ObjectStore_defaultActionStore().stringForm()));
...
public static void main (String[] args)
    {
	Uid u = new Uid();
	String timeout = System.getProperty(pollingTimeout);
