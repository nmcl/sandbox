 ...
 * UK.
 *
 * $Id: LockManager.java,v 1.12.2.1.4.1 1999/06/23 13:43:19 nmcl Exp $
 */
...
private final boolean doRelease (Uid u, boolean all)
    ...
    /*
     * When we move to the pure in-memory locks (i.e., not even an in-memory
     * lock store) we must change this so that it does not purge the locks
     * from the object unless a separate lock store is keeping a copy! We do
     * this in C++ now for performance.
     */
