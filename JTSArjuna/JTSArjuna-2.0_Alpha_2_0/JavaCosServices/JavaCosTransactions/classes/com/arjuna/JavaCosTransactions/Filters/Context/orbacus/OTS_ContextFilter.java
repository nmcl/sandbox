 ...
 * UK.
 *
 * $Id: OTS_ContextFilter.java,v 1.1 2000/01/27 15:25:38 nmcl Exp $
 */
...
public org.omg.CORBA.portable.OutputStream postDispatch (org.omg.CORBA.DynamicImplementation p, String op,
	...
	{
	    System.err.println("WARNING - OTS_ContextFilter.postDispatch caught: "+ex);
	    return buf;
	}
	catch (Exception e)
	{
	    System.err.println("WARNING - OTS_ContextFilter.postDispatch caught exception "+e);
	    return buf;
	}
