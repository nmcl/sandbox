 ...
 * UK.
 *
 * $Id: OTS_TransactionReaper.java,v 1.10.2.1.2.1 1999/04/16 13:47:37 nmcl Exp $
 */
...
public static synchronized OTS_TransactionReaper create (long checkPeriod)
	...
	{
	    String timeoutEnv = System.getProperty(OTS_Environment.OTS_TX_REAPER_TIMEOUT);
