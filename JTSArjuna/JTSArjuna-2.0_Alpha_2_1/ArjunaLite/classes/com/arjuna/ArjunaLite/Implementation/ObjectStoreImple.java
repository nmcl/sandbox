 ...
 * UK.  
 *
 * $Id: ObjectStoreImple.java,v 1.1 2000/02/25 14:04:02 nmcl Exp $
 */
...
public String locateStore (String location) throws ObjectStoreException
    {
	String objectStoreRoot = PropertyManager.getProperty(ArjunaLiteEnvironment.LOCALOSROOT);
	String finalLocation = PropertyManager.getProperty(ArjunaLiteEnvironment.OBJECTSTORE_DIR,
							   com.arjuna.ArjunaLite.Common.Configuration.objectStoreRoot());

	if (finalLocation == null)
	    throw new ObjectStoreException(ArjunaLiteEnvironment.OBJECTSTORE_DIR+" not set.");
