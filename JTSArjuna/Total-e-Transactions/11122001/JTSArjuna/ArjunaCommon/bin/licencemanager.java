 ...
 * UK.
 * 
 * $Id: licencemanager.java,v 1.2.26.1 2000/10/20 12:59:38 nmcl Exp $
 */
...
public static void usage (String name)
    {
	System.out.println("Usage: "+name+" -licensee <name> -licence <licence> -version <number> [-file <db file>] [-key <key>] [-help]");
    }
    
private static String dbFile = "/var/tmp/JTSArjunaLicence.db";
...
public static void main (String[] args)
	...
	try
	{
	    ...
	    long theTime = (long) (suppliedDate ^ 0xbeca54d2)*1000L;
	    Date date = new Date(theTime);

	    output.print("JTSArjuna: "+version+"\t"+licensee+"\t"+licence+"\t"+date+"\t");
