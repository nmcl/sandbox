 ...
 * UK.  
 *
 * $Id: Lock.java,v 1.1.4.1.2.2.4.2 2001/01/04 12:35:56 nmcl Exp $
 */
 ...
 * @version $Id: Lock.java,v 1.1.4.1.2.2.4.2 2001/01/04 12:35:56 nmcl Exp $
 * @since JTS 1.0.
 */
...
public final int getLockMode ()
	...
	if (DebugController.enabled())
	{
	    DebugController.controller().println(DebugLevel.TRIVIAL_FUNCS, VisibilityLevel.VIS_PUBLIC,
...
public String toString ()
	...
	strm.write("\n\tMode : "+LockMode.printString(lMode));
...
private static int applicPid = com.arjuna.ArjunaCommon.Common.Utility.getpid();  /* process id */
