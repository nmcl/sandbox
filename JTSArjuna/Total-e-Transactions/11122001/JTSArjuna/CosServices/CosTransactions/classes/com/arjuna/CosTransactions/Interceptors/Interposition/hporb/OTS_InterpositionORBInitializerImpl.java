 ...
 * UK.  
 *
 * $Id: OTS_InterpositionORBInitializerImpl.java,v 1.1.2.1 2001/12/11 13:34:23 nmcl Exp $
 */
...
public void pre_init (ORBInitInfo init_info)
	...
	if (DebugController.enabled())
	{
	    DebugController.controller().println(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					       (FacilityCode.FAC_OTS | FacilityCode.FAC_FILTER), "OTS_InterpositionORBInitializerImpl.pre_init ()");
	}
...
public void post_init (ORBInitInfo init_info)
	...
	{
	    DebugController.controller().println(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					       (FacilityCode.FAC_OTS | FacilityCode.FAC_FILTER), "OTS_InterpositionORBInitializer.post_init ()");
	}
