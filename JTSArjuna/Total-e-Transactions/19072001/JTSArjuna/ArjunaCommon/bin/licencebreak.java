 ...
 * UK.  
 * 
 * $Id: licencebreak.java,v 1.3.4.1.14.3.12.1.4.1 2001/01/04 12:46:23 nmcl Exp $
 */
...
public static void main (String[] args)
	...
	if (ok)
	{
	    ...
	    if (index2 != -1)
	    {
		eString = li.substring(index1 +1, index2);
		index1 = index2;
	    }
	    else
		ok = false;
	...
	if (ok)
	{
		...
		cString = li.substring(index1 +1, index2);
	}
	...
	if (ok)
	{
	    ...
	    int suppliedCode = (int) Utility.hexStringToLong(eString);
	    ...
	    int originalCode = suppliedCode ^ 0x1dc4fa42;
	    ...
	    System.out.println("\nEnable code: "+com.arjuna.ArjunaCommon.Core.LicenceType.litype(originalCode));
	}
	else
