 ...
 * UK.
 *
 * $Id: DebugController.java,v 1.2.4.1.6.3.2.3.20.1.2.2.2.1.2.1 2001/02/01 15:16:06 nmcl Exp $
 */
 ...
 * @version $Id: DebugController.java,v 1.2.4.1.6.3.2.3.20.1.2.2.2.1.2.1 2001/02/01 15:16:06 nmcl Exp $
 * @since JTS 1.2.4.
 */
...
private static long            _debugLevel;
private static long            _visLevel;
private static long            _facLevel;
...
private static boolean         _enabled = false;
	...
	if (dLevel != null)
	{
	    try
	    {
		_debugLevel = Utility.hexStringToLong(dLevel);
	    }
	    catch (Exception e)
	    {
		e.printStackTrace();
	...
	if (vLevel != null)
	{
	    try
	    {
		_visLevel = Utility.hexStringToLong(vLevel);
	    }
	    catch (Exception e)
	    {
		e.printStackTrace();
	...
	if (fLevel != null)
	{
	    try
	    {
		_facLevel = Utility.hexStringToLong(fLevel);
	    }
	    catch (Exception e)
	    {
		e.printStackTrace();
