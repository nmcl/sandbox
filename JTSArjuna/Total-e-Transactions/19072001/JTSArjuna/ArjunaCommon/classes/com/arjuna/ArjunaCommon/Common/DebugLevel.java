 ...
 * UK.
 *
 * $Id: DebugLevel.java,v 1.2.8.1.22.1.4.2.2.1.32.1 2001/06/15 12:04:01 nmcl Exp $
 */
 ...
 * @version $Id: DebugLevel.java,v 1.2.8.1.22.1.4.2.2.1.32.1 2001/06/15 12:04:01 nmcl Exp $
 * @since JTS 1.2.4.
 */
...
public static final long CONSTRUCTORS = 0x0001;
public static final long DESTRUCTORS = 0x0002;
public static final long CONSTRUCT_AND_DESTRUCT = CONSTRUCTORS | DESTRUCTORS;
public static final long FUNCTIONS = 0x0010;
public static final long OPERATORS = 0x0020;
...
public static final long TRIVIAL_FUNCS = 0x0100;
public static final long TRIVIAL_OPERATORS = 0x0200;
public static final long ALL_TRIVIAL = TRIVIAL_FUNCS | TRIVIAL_OPERATORS;
public static final long ERROR_MESSAGES = 0x0400;
public static final long FULL_DEBUGGING = 0xffff;
