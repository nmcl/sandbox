 ...
 * UK.
 *
 * $Id: HashedStore.java,v 1.1.4.1.2.2.2.2.2.3 2001/01/05 17:59:29 pfurniss Exp $
 */
 ...
 * @version $Id: HashedStore.java,v 1.1.4.1.2.2.2.2.2.3 2001/01/05 17:59:29 pfurniss Exp $
 * @since JTS 2.0.
 */
...
protected String genPathName (Uid objUid, String tName, int m) throws ObjectStoreException
	...
	{
	    DebugController.controller().println(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PROTECTED,
					       FacilityCode.FAC_OBJECT_STORE, "HashedStore.genPathName("+objUid+", "+tName+", "+m+")");
	}
