...
public class RecoveryManagerHelper
{
    ...
    public static com.arjuna.CosRecovery.Admin.RecoveryManager extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            _type = _orb().create_interface_tc(id(), "RecoveryManager");
        }
        return _type;
    }
    ...
    {
        return "IDL:CosRecovery.arjuna.com/Admin/RecoveryManager:1.0";
    }

    public static com.arjuna.CosRecovery.Admin.RecoveryManager read(
    ...
    public static com.arjuna.CosRecovery.Admin.RecoveryManager narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof com.arjuna.CosRecovery.Admin.RecoveryManager)
        {
            return (com.arjuna.CosRecovery.Admin.RecoveryManager)_obj;
        }
        if (_obj._is_a(id()))
        {
            com.arjuna.CosRecovery.Admin._RecoveryManagerStub _ref = new com.arjuna.CosRecovery.Admin._RecoveryManagerStub();
