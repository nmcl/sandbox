 ...
 * UK.
 *
 * $Id: GenericRecoveryCoordinator.javatmpl,v 1.1.2.2.2.3.2.1.12.1.2.3.4.1 2001/06/15 12:08:53 nmcl Exp $
 */
 ...
 * @version $Id: GenericRecoveryCoordinator.javatmpl,v 1.1.2.2.2.3.2.1.12.1.2.3.4.1 2001/06/15 12:08:53 nmcl Exp $ 
*/
...
private static Status get_status (Uid actionUid, Uid processUid) throws Inactive
	...
	try
	{
	    status = StatusChecker.get_status(actionUid, processUid);
	}
	catch (Inactive e)
	{
	    // original process is dead.
