 ...
 * UK.
 *
 * $Id: RecoveredTransactionalObject.java,v 1.1.2.3.2.2.14.1 2001/04/12 13:28:43 nmcl Exp $
 */
 ...
 * @version $Id: RecoveredTransactionalObject.java,v 1.1.2.3.2.2.14.1 2001/04/12 13:28:43 nmcl Exp $ 
 */
...
public class RecoveredTransactionalObject extends StateManager
{
	...
	if (findHoldingTransaction()) {
		...
		if (DebugController.enabled())
		{
		    DebugController.controller().println(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
			    FacilityCode.FAC_CRASH_RECOVERY,
			    "transaction Status from original application " + tranStatus + " and inactive: "+inactive);
		}
	    }
