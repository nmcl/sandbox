...
public class ActionControlHelper
{
    public static void insert(
        ...
        com.arjuna.ArjunaOTS.ActionControl value
    )
    {
        any.type(type());
    ...
    public static com.arjuna.ArjunaOTS.ActionControl extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            _type = _orb().create_interface_tc(id(), "ActionControl");
        }
        return _type;
    }
    ...
    public static com.arjuna.ArjunaOTS.ActionControl read(
    ...
    public static com.arjuna.ArjunaOTS.ActionControl narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof com.arjuna.ArjunaOTS.ActionControl)
        {
            return (com.arjuna.ArjunaOTS.ActionControl)_obj;
        }
        if (_obj._is_a(id()))
        {
            com.arjuna.ArjunaOTS._ActionControlStub _ref = new com.arjuna.ArjunaOTS._ActionControlStub();
