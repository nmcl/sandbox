...
public class ActiveThreadsHelper
{
    ...
    public static com.arjuna.ArjunaOTS.ActiveThreads extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"ActiveThreads",_s);
        }
        return _type;
    }
    ...
    {
        return "IDL:arjuna.com/ArjunaOTS/ActiveThreads:1.0";
    }

    public static com.arjuna.ArjunaOTS.ActiveThreads read(
        org.omg.CORBA.portable.InputStream _stream
    )
    {
        // read and discard the repository id
        _stream.read_string();
        com.arjuna.ArjunaOTS.ActiveThreads value = new com.arjuna.ArjunaOTS.ActiveThreads();
