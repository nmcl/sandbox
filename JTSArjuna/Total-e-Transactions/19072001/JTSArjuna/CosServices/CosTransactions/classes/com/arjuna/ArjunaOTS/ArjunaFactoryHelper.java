...
public class ArjunaFactoryHelper
{
    public static void insert(
        org.omg.CORBA.Any any,
        com.arjuna.ArjunaOTS.ArjunaFactory value
    )
    {
        any.type(type());
    ...
    public static com.arjuna.ArjunaOTS.ArjunaFactory extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            _type = _orb().create_interface_tc(id(), "ArjunaFactory");
        }
        return _type;
    }
    ...
    {
        return "IDL:arjuna.com/ArjunaOTS/ArjunaFactory:1.0";
    }

    public static com.arjuna.ArjunaOTS.ArjunaFactory read(
    ...
    public static com.arjuna.ArjunaOTS.ArjunaFactory narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof com.arjuna.ArjunaOTS.ArjunaFactory)
        {
            return (com.arjuna.ArjunaOTS.ArjunaFactory)_obj;
        }
        if (_obj._is_a(id()))
        {
            com.arjuna.ArjunaOTS._ArjunaFactoryStub _ref = new com.arjuna.ArjunaOTS._ArjunaFactoryStub();
