...
public class ArjunaTransactionHelper
{
    public static void insert(
        org.omg.CORBA.Any any,
        com.arjuna.ArjunaOTS.ArjunaTransaction value
    )
    {
        any.type(type());
    ...
    public static com.arjuna.ArjunaOTS.ArjunaTransaction extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            _type = _orb().create_interface_tc(id(), "ArjunaTransaction");
        }
        return _type;
    }
    ...
    {
        return "IDL:arjuna.com/ArjunaOTS/ArjunaTransaction:1.0";
    }

    public static com.arjuna.ArjunaOTS.ArjunaTransaction read(
    ...
    public static com.arjuna.ArjunaOTS.ArjunaTransaction narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof com.arjuna.ArjunaOTS.ArjunaTransaction)
        {
            return (com.arjuna.ArjunaOTS.ArjunaTransaction)_obj;
        }
        if (_obj._is_a(id()))
        {
            com.arjuna.ArjunaOTS._ArjunaTransactionStub _ref = new com.arjuna.ArjunaOTS._ArjunaTransactionStub();
