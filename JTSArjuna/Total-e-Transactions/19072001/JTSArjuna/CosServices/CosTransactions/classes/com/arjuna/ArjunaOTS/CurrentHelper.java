...
public class CurrentHelper
{
    ...
    public static com.arjuna.ArjunaOTS.Current extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    {
        return "IDL:arjuna.com/ArjunaOTS/Current:1.0";
    }

    public static com.arjuna.ArjunaOTS.Current read(
    ...
    public static com.arjuna.ArjunaOTS.Current narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof com.arjuna.ArjunaOTS.Current)
        {
            return (com.arjuna.ArjunaOTS.Current)_obj;
        }
        if (_obj._is_a(id()))
        {
            com.arjuna.ArjunaOTS._CurrentStub _ref = new com.arjuna.ArjunaOTS._CurrentStub();
