...
public class DestroyedHelper
{
    ...
    public static com.arjuna.ArjunaOTS.Destroyed extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"Destroyed",_s);
        }
        return _type;
    }
    ...
    {
        return "IDL:arjuna.com/ArjunaOTS/Destroyed:1.0";
    }

    public static com.arjuna.ArjunaOTS.Destroyed read(
        org.omg.CORBA.portable.InputStream _stream
    )
    {
        // read and discard the repository id
        _stream.read_string();
        com.arjuna.ArjunaOTS.Destroyed value = new com.arjuna.ArjunaOTS.Destroyed();
