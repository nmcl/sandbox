...
public class OTSAbstractRecordHelper
{
    ...
    public static com.arjuna.ArjunaOTS.OTSAbstractRecord extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            _type = _orb().create_interface_tc(id(), "OTSAbstractRecord");
        }
        return _type;
    }
    ...
    public static com.arjuna.ArjunaOTS.OTSAbstractRecord read(
    ...
    public static com.arjuna.ArjunaOTS.OTSAbstractRecord narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof com.arjuna.ArjunaOTS.OTSAbstractRecord)
        {
            return (com.arjuna.ArjunaOTS.OTSAbstractRecord)_obj;
        }
        if (_obj._is_a(id()))
        {
            com.arjuna.ArjunaOTS._OTSAbstractRecordStub _ref = new com.arjuna.ArjunaOTS._OTSAbstractRecordStub();
