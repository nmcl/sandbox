...
public class UidCoordinatorHelper
{
    ...
    public static com.arjuna.ArjunaOTS.UidCoordinator extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            _type = _orb().create_interface_tc(id(), "UidCoordinator");
        }
        return _type;
    }
    ...
    {
        return "IDL:arjuna.com/ArjunaOTS/UidCoordinator:1.0";
    }

    public static com.arjuna.ArjunaOTS.UidCoordinator read(
    ...
    public static com.arjuna.ArjunaOTS.UidCoordinator narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof com.arjuna.ArjunaOTS.UidCoordinator)
        {
            return (com.arjuna.ArjunaOTS.UidCoordinator)_obj;
        }
        if (_obj._is_a(id()))
        {
            com.arjuna.ArjunaOTS._UidCoordinatorStub _ref = new com.arjuna.ArjunaOTS._UidCoordinatorStub();
