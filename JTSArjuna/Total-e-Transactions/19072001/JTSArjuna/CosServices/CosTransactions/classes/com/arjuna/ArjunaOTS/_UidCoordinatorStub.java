...
public class _UidCoordinatorStub
    extends org.omg.CORBA.portable.ObjectImpl
    implements UidCoordinator, org.omg.CosTransactions.Coordinator
{
    final public static java.lang.Class _opsClass = UidCoordinatorOperations.class;


    public _UidCoordinatorStub () {}
    ...
    public org.omg.CosTransactions.Status get_status()
    {
        while (true) {
            if(!_is_local()) {
                ...
                UidCoordinatorOperations _self = (UidCoordinatorOperations)_so.servant;
                try {
    ...
    {"IDL:omg.org/CosTransactions/Coordinator:1.0", "IDL:arjuna.com/ArjunaOTS/UidCoordinator:1.0"};
