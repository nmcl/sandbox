 ...
 * UK.  
 *
 * $Id: Init.java,v 1.1.6.2.24.1 2000/11/08 14:30:28 nmcl Exp $
 */
...
public Init ()
	...
	{
	    ErrorStream.stream(ErrorStream.FATAL).println("OTS_InterpositionFilter initialisation failed with: "+e);
