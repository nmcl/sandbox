 ...
 * UK.  
 *
 * $Id: OTS_ClientContextInterceptor.java,v 1.1.8.2.24.1 2000/11/16 15:34:33 nmcl Exp $
 */
...
public void preinvoke_postmarshal (org.omg.CORBA.Object target,
	...
	else
	{
		...
		{
		    ErrorStream.stream(ErrorStream.WARNING).println("OTS_ClientContextInterceptor.preinvoke_postmarshal - caught unexpected exception: "+e);
		}
	    }
