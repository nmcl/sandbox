 ...
 * UK.  
 *
 * $Id: OTS_ServerContextInterceptor.java,v 1.4.8.2.24.1 2000/11/16 15:34:34 nmcl Exp $
 */
...
public void preinvoke (org.omg.CORBA.Object target, String operation,
	...
	else
	{
	    ...
	    {
		ErrorStream.stream(ErrorStream.WARNING).println("OTS_ServerContextInterceptor.preinvoke - caught InvalidControl: "+e1);
	    }
	    catch (SystemException e2)
	    {
		ErrorStream.stream(ErrorStream.WARNING).println("OTS_ServerContextInterceptor.preinvoke - caught unexpected exception: "+e2);
	    }
...
public void postinvoke_postmarshal (org.omg.CORBA.Object target,
	...
	{
	    ErrorStream.stream(ErrorStream.WARNING).println("OTS_ServerContextInterceptor.postinvoke_postmarshal caught: "+e);
	}
    }
