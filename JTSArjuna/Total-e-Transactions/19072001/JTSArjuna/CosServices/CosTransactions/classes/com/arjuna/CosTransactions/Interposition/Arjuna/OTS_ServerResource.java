 ...
 * UK.  
 *
 * $Id: OTS_ServerResource.javatmpl,v 1.5.6.1.2.2.8.2.10.2.2.2.2.1 2000/12/21 11:21:21 nmcl Exp $
 */
 ...
 * @version $Id: OTS_ServerResource.javatmpl,v 1.5.6.1.2.2.8.2.10.2.2.2.2.1 2000/12/21 11:21:21 nmcl Exp $
 * @since JTS 1.0.
 */
...
public final boolean abortChild (OTS_ServerNestedAction toAbort)
	...
	if ((_children != null) && (toAbort != null))
	{
		...
		try
		{
		    OAInterface.shutdownObject( child.theResource() ) ;
		}
		catch (Exception e)
		{
		}
...
protected void tidyup ()
	...
	if (_children != null)
	{
		...
		try
		{
		    OAInterface.shutdownObject( ptr.theResource() ) ;
		}
		catch (Exception e)
		{
		}
