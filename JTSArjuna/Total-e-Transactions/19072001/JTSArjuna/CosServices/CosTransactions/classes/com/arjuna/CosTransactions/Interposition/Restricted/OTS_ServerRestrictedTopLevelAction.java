 ...
 * UK.
 *
 * $Id: OTS_ServerRestrictedTopLevelAction.java,v 1.1.8.2.8.1.14.1.2.1.2.1 2000/12/13 15:40:25 nmcl Exp $
 */
...
public OTS_ServerRestrictedTopLevelAction (OTS_ServerControl myControl)
	...
	if (DebugController.enabled())
	{
	    DebugController.controller().println(DebugLevel.CONSTRUCTORS, VisibilityLevel.VIS_PUBLIC,
					       FacilityCode.FAC_OTS, "OTS_ServerRestrictedTopLevelAction::OTS_ServerRestrictedTopLevelAction ( "+
...
public final synchronized OTS_ServerRestrictedNestedAction child ()
	...
	if (children != null)
	{
	    if (children.size() != 1)
	    {
		ErrorStream.stream(ErrorStream.FATAL).println("OTS_ServerRestrictedTopLevelAction.child - found concurrent transactions!");
