 ...
 * UK.
 *
 * $Id: OTS_Control.javatmpl,v 1.13.2.2.2.2.2.2.2.1.6.3.10.1.2.1.2.4.2.1 2001/02/14 10:46:55 nmcl Exp $
 */
 ...
 * @version $Id: OTS_Control.javatmpl,v 1.13.2.2.2.2.2.2.2.1.6.3.10.1.2.1.2.4.2.1 2001/02/14 10:46:55 nmcl Exp $
 * @since JTS 1.0.
 */

public class OTS_Control extends  com.arjuna.ArjunaOTS . ActionControlPOA 
{
...
public final synchronized Control getControl ()
	...
	if (_myControl == null)
	{
	    ...
	    _myControl =  com.arjuna.ArjunaOTS.ActionControlHelper.narrow(OAInterface.corbaReference( this )) ;
	}
	
	return  org.omg.CosTransactions.ControlHelper.narrow(_myControl) ;
    }
...
public Coordinator get_coordinator () throws SystemException, org.omg.CosTransactions.Unavailable
	...
	if (_theCoordinator != null)
	    return  org.omg.CosTransactions.CoordinatorHelper.narrow(_theCoordinator) ;
	else
	    throw new Unavailable();
    }
...
protected final void createTransactionHandle ()
	...
	OAInterface.objectIsReady( _transactionImpl ) ;

	ArjunaTransaction transactionReference =  com.arjuna.ArjunaOTS.ArjunaTransactionHelper.narrow(OAInterface.corbaReference( _transactionImpl )) ;
...
protected final void tidyup ()
	...
	try
	{
	    ...
	    {
		OAInterface.shutdownObject( _transactionImpl ) ;
