...
public class ControlHelper
{
    ...
    public static org.omg.CosTransactions.Control extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            _type = _orb().create_interface_tc(id(), "Control");
        }
        return _type;
    }
    ...
    public static org.omg.CosTransactions.Control read(
    ...
    public static org.omg.CosTransactions.Control narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof org.omg.CosTransactions.Control)
        {
            return (org.omg.CosTransactions.Control)_obj;
        }
        if (_obj._is_a(id()))
        {
            org.omg.CosTransactions._ControlStub _ref = new org.omg.CosTransactions._ControlStub();
