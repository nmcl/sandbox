...
public class CurrentHelper
{
    ...
    public static org.omg.CosTransactions.Current extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CosTransactions.Current read(
    ...
    public static org.omg.CosTransactions.Current narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof org.omg.CosTransactions.Current)
        {
            return (org.omg.CosTransactions.Current)_obj;
        }
        if (_obj._is_a(id()))
        {
            org.omg.CosTransactions._CurrentStub _ref = new org.omg.CosTransactions._CurrentStub();
