...
public class InactiveHelper
{
    public static void insert(
        ...
        org.omg.CosTransactions.Inactive value
    )
    {
        any.type(type());
    ...
    public static org.omg.CosTransactions.Inactive extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"Inactive",_s);
        }
        return _type;
    }
    ...
    public static org.omg.CosTransactions.Inactive read(
