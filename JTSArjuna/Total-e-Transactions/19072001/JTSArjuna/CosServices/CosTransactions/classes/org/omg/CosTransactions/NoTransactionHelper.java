...
public class NoTransactionHelper
{
    ...
    public static org.omg.CosTransactions.NoTransaction extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"NoTransaction",_s);
        }
        return _type;
    }
    ...
    public static org.omg.CosTransactions.NoTransaction read(
