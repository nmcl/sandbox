...
public class NotPreparedHelper
{
    public static void insert(
        ...
        org.omg.CosTransactions.NotPrepared value
    )
    {
        any.type(type());
    ...
    public static org.omg.CosTransactions.NotPrepared extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"NotPrepared",_s);
        }
        return _type;
    }
    ...
    public static org.omg.CosTransactions.NotPrepared read(
