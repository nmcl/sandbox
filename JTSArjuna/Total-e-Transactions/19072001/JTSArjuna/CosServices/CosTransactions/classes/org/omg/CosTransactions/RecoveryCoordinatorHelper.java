...
public class RecoveryCoordinatorHelper
{
    ...
    public static org.omg.CosTransactions.RecoveryCoordinator extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            _type = _orb().create_interface_tc(id(), "RecoveryCoordinator");
        }
        return _type;
    }
    ...
    public static org.omg.CosTransactions.RecoveryCoordinator read(
    ...
    public static org.omg.CosTransactions.RecoveryCoordinator narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof org.omg.CosTransactions.RecoveryCoordinator)
        {
            return (org.omg.CosTransactions.RecoveryCoordinator)_obj;
        }
        if (_obj._is_a(id()))
        {
            org.omg.CosTransactions._RecoveryCoordinatorStub _ref = new org.omg.CosTransactions._RecoveryCoordinatorStub();
