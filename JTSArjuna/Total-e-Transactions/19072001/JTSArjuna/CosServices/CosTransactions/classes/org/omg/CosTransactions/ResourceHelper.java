...
public class ResourceHelper
{
    ...
    public static org.omg.CosTransactions.Resource extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            _type = _orb().create_interface_tc(id(), "Resource");
        }
        return _type;
    }
    ...
    public static org.omg.CosTransactions.Resource read(
    ...
    public static org.omg.CosTransactions.Resource narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof org.omg.CosTransactions.Resource)
        {
            return (org.omg.CosTransactions.Resource)_obj;
        }
        if (_obj._is_a(id()))
        {
            org.omg.CosTransactions._ResourceStub _ref = new org.omg.CosTransactions._ResourceStub();
