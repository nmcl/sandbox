...
public class SubtransactionAwareResourceHelper
{
    ...
    public static org.omg.CosTransactions.SubtransactionAwareResource extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            _type = _orb().create_interface_tc(id(), "SubtransactionAwareResource");
        }
        return _type;
    }
    ...
    public static org.omg.CosTransactions.SubtransactionAwareResource read(
    ...
    public static org.omg.CosTransactions.SubtransactionAwareResource narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof org.omg.CosTransactions.SubtransactionAwareResource)
        {
            return (org.omg.CosTransactions.SubtransactionAwareResource)_obj;
        }
        if (_obj._is_a(id()))
        {
            org.omg.CosTransactions._SubtransactionAwareResourceStub _ref = new org.omg.CosTransactions._SubtransactionAwareResourceStub();
