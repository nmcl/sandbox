...
public class SubtransactionsUnavailableHelper
{
    ...
    public static org.omg.CosTransactions.SubtransactionsUnavailable extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            ...
            _type = _orb().create_exception_tc(id(),"SubtransactionsUnavailable",_s);
        }
        return _type;
    }
    ...
    public static org.omg.CosTransactions.SubtransactionsUnavailable read(
