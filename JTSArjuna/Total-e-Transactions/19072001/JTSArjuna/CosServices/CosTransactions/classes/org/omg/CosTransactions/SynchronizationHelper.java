...
public class SynchronizationHelper
{
    ...
    public static org.omg.CosTransactions.Synchronization extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            _type = _orb().create_interface_tc(id(), "Synchronization");
        }
        return _type;
    }
    ...
    public static org.omg.CosTransactions.Synchronization read(
    ...
    public static org.omg.CosTransactions.Synchronization narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof org.omg.CosTransactions.Synchronization)
        {
            return (org.omg.CosTransactions.Synchronization)_obj;
        }
        if (_obj._is_a(id()))
        {
            org.omg.CosTransactions._SynchronizationStub _ref = new org.omg.CosTransactions._SynchronizationStub();
