...
public class TerminatorHelper
{
    ...
    public static org.omg.CosTransactions.Terminator extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            _type = _orb().create_interface_tc(id(), "Terminator");
        }
        return _type;
    }
    ...
    public static org.omg.CosTransactions.Terminator read(
    ...
    public static org.omg.CosTransactions.Terminator narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof org.omg.CosTransactions.Terminator)
        {
            return (org.omg.CosTransactions.Terminator)_obj;
        }
        if (_obj._is_a(id()))
        {
            org.omg.CosTransactions._TerminatorStub _ref = new org.omg.CosTransactions._TerminatorStub();
