...
public class TransactionFactoryHelper
{
    ...
    public static org.omg.CosTransactions.TransactionFactory extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            _type = _orb().create_interface_tc(id(), "TransactionFactory");
        }
        return _type;
    }
    ...
    public static org.omg.CosTransactions.TransactionFactory read(
    ...
    public static org.omg.CosTransactions.TransactionFactory narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof org.omg.CosTransactions.TransactionFactory)
        {
            return (org.omg.CosTransactions.TransactionFactory)_obj;
        }
        if (_obj._is_a(id()))
        {
            org.omg.CosTransactions._TransactionFactoryStub _ref = new org.omg.CosTransactions._TransactionFactoryStub();
