...
public class TransactionalObjectHelper
{
    ...
    public static org.omg.CosTransactions.TransactionalObject extract(
        org.omg.CORBA.Any any
    )
    {
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_type == null)
        {
            _type = _orb().create_interface_tc(id(), "TransactionalObject");
        }
        return _type;
    }
    ...
    public static org.omg.CosTransactions.TransactionalObject read(
    ...
    public static org.omg.CosTransactions.TransactionalObject narrow(
    ...
    ) throws org.omg.CORBA.BAD_PARAM
    {
        ...
        if (_obj instanceof org.omg.CosTransactions.TransactionalObject)
        {
            return (org.omg.CosTransactions.TransactionalObject)_obj;
        }
        if (_obj._is_a(id()))
        {
            org.omg.CosTransactions._TransactionalObjectStub _ref = new org.omg.CosTransactions._TransactionalObjectStub();
