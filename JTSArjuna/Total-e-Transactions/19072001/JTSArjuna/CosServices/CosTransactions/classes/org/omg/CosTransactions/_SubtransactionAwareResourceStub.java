...
public class _SubtransactionAwareResourceStub
    ...
    implements SubtransactionAwareResource, org.omg.CosTransactions.Resource
{
    final public static java.lang.Class _opsClass = SubtransactionAwareResourceOperations.class;
    ...
    public org.omg.CosTransactions.Vote prepare() throws org.omg.CosTransactions.HeuristicMixed, org.omg.CosTransactions.HeuristicHazard
    {
        while (true) {
            if(!_is_local()) {
                ...
                SubtransactionAwareResourceOperations _self = (SubtransactionAwareResourceOperations)_so.servant;
                try {
    ...
    {"IDL:omg.org/CosTransactions/SubtransactionAwareResource:1.0", "IDL:omg.org/CosTransactions/Resource:1.0"};
