...
public Info (String s)
	...
	_attributes.put(_keys[0], "ArjunaTS" );
	_attributes.put(_keys[1], "2" );
	_attributes.put(_keys[2], "2" );
	_attributes.put(_keys[3], "0" );
	_attributes.put(_keys[4], "Beta" );
	_attributes.put(_keys[5], "internal" );
	_attributes.put(_keys[6], "JTSArjuna" );
	_attributes.put(_keys[7], "unknown" );
	_attributes.put(_keys[8], "Arjuna Solutions Ltd. [unknown]" );
	_attributes.put(_keys[9], "Thu Sep 20 13:40:33 2001" );
	_attributes.put(_keys[10], "none" );
	_attributes.put(_keys[11], "2_2_0" );
