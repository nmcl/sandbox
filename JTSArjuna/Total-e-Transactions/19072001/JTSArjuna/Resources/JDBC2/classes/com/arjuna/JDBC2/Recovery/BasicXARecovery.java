...
import com.arjuna.JDBC2.Recovery.XAConnectionRecovery;
...
public boolean initialise (String parameter) throws SQLException
	...
	if (breakPosition != -1)
	{
	    ...
	    {
		ErrorStream.warning().println("BasicXARecovery.initialise - caught: "+e);
...
public synchronized JDBC2RecoveryConnection getConnection () throws SQLException
    {
	...
	if (hasMoreConnections())
	{
	    ...
	    if (conn == null)
		ErrorStream.warning().println("BasicXARecovery.getConnection - could not find information for connection!");
	}
...
private static final String jndiTag = "JNDI_";
     ...
     * DB2_DatabaseDynamicClass=com.arjuna.JDBC2.drivers.sequelink_5_0
     *
