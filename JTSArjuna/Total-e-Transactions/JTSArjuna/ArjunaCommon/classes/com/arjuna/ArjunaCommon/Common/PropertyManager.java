 ...
 * UK.
 *
 * $Id: PropertyManager.java,v 1.2.4.1.6.2.20.1.2.4.2.1.2.3.4.12.6.1.2.3.16.2.22.2 2001/11/27 13:37:02 nmcl Exp $
 */
 ...
 * @version $Id: PropertyManager.java,v 1.2.4.1.6.2.20.1.2.4.2.1.2.3.4.12.6.1.2.3.16.2.22.2 2001/11/27 13:37:02 nmcl Exp $
 * @since JTS 1.0.
 */
...
public static void setProperty (String name, String property, boolean flush)
    {
	setProperty(name, property, flush, false);
    }
...
public static synchronized final boolean setPropertyImple (String className)
    {
	boolean res = false;
...
private static String defaultImplementation = com.arjuna.ArjunaCommon.Common.implementations.PropertyService.PropertyFileImple.class.getName();
