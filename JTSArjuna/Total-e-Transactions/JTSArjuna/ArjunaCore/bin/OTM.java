 ...
 * UK.  
 *
 * $Id: OTM.java,v 1.1.4.1 2000/10/16 16:00:06 nmcl Exp $
 */
...
public synchronized void updateTransactions ()
	...
	if (scanningNode != null)
	{
	    ...
	    try
	    {
		ClassName actionStoreType = new ClassName(PropertyManager.getProperty(ArjunaCoreEnvironment.ACTION_STORE,
									     ArjunaCoreNames.Implementation_ObjectStore_defaultActionStore().stringForm()));
...
public static void main (String[] args)
    {
	Uid u = new Uid();
	String timeout = PropertyManager.getProperty(pollingTimeout);
