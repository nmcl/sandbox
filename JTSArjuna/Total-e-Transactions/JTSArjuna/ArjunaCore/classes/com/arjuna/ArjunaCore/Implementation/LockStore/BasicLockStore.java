 ...
 * UK.  
 *
 * $Id: BasicLockStore.java,v 1.1.4.1.2.1.4.1 2000/12/21 11:21:09 nmcl Exp $
 */
 ...
 * @version $Id: BasicLockStore.java,v 1.1.4.1.2.1.4.1 2000/12/21 11:21:09 nmcl Exp $
 * @since JTS 1.0.
 */
...
public boolean write_committed (Uid u, String tName, OutputObjectState state)
	...
	{
	    DebugController.controller().println(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
						 FacilityCode.FAC_LOCK_STORE, "BasicLockStore.write_committed("+u+", "+tName+", "+state+")");
	}
