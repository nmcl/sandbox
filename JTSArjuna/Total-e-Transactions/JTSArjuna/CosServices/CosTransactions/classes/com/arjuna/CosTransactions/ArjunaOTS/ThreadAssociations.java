 ...
 * UK.
 *
 * $Id: ThreadAssociations.java,v 1.5.6.1.26.1.4.2.34.1.4.1.54.1 2002/05/27 10:43:15 nmcl Exp $
 */
 ...
 * @version $Id: ThreadAssociations.java,v 1.5.6.1.26.1.4.2.34.1.4.1.54.1 2002/05/27 10:43:15 nmcl Exp $
 * @since JTS 2.0.
 */
...
final static void updateAssociation (OTS_ControlWrapper tx, int reason)
    {
	...
	try
	{
	    synchronized (txAssociations)
		{
			...
			for (int i = 0; i < v.size(); i++)
			{
			    ...
			    {
				ErrorStream.warning().println("ThreadAssociations.updateAssociations: "+e);
...
private static void update (TxAssociation ta, OTS_ControlWrapper tx,
