...
public OTS_ContextFilter ()
	...
	if (DebugController.enabled())
	{
	    DebugController.controller().print(DebugLevel.CONSTRUCTORS, VisibilityLevel.VIS_PUBLIC,
					       (FacilityCode.FAC_OTS | FacilityCode.FAC_FILTER), "OTS_ContextFilter::OTS_ContextFilter ()");
	}
    }
...
public void sendingRequest (int requestId, OutputStream os)
	...
	if (DebugController.enabled())
	{
	    DebugController.controller().print(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					       (FacilityCode.FAC_OTS | FacilityCode.FAC_FILTER), "OTS_ContextFilter::sendingRequest ( "+requestId+" )");
	}
...
public void sendingReply(int requestId, OutputStream contextIS)
	...
	{
	    DebugController.controller().print(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					       (FacilityCode.FAC_OTS | FacilityCode.FAC_FILTER), "OTS_ContextFilter::sendingReply ( "+requestId+" )");
	}
	...
	{
	    ErrorStream.stream(ErrorStream.WARNING).println("OTS_ContextFilter::sendingReply caught: "+ex);
	    throw ex;
	}
	catch (Exception e)
	{
	    ErrorStream.stream(ErrorStream.WARNING).println("OTS_ContextFilter::sendingReply caught exception: "+e);
...
public void receivedRequest(int requestId, InputStream s)
	...
	{
	    DebugController.controller().print(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					       (FacilityCode.FAC_OTS | FacilityCode.FAC_FILTER), "OTS_ContextFilter::receivedRequest ( "+requestId+" )");
	}
...
public void receivedReply(int requestId, InputStream contextIS, Exception ex)
	...
	{
	    DebugController.controller().print(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					       (FacilityCode.FAC_OTS | FacilityCode.FAC_FILTER), "OTS_ContextFilter::receivedReply ( "+requestId+" )");
	}
    }
