 ...
 * UK.  
 *
 * $Id: OTS_InterpositionFilter.java,v 1.1.6.1.6.2.2.1.22.2 2000/11/16 15:34:25 nmcl Exp $
 */
...
public org.omg.CORBA.portable.OutputStream preRequest (org.omg.CORBA.portable.ObjectImpl obj,
	...
	if (DebugController.enabled())
	{
	    DebugController.controller().print(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					       (FacilityCode.FAC_OTS | FacilityCode.FAC_FILTER), "OTS_InterpositionFilter::preRequest ( "+op+" )");
	}
...
public org.omg.CORBA.portable.InputStream postRequest (org.omg.CORBA.portable.ObjectImpl obj,
	...
	{
	    DebugController.controller().print(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					       (FacilityCode.FAC_OTS | FacilityCode.FAC_FILTER), "OTS_InterpositionFilter::postRequest ( "+op+" )");
	}
...
public org.omg.CORBA.portable.InputStream preDispatch (org.omg.CORBA.DynamicImplementation p, String op,
	...
	{
	    DebugController.controller().print(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					       (FacilityCode.FAC_OTS | FacilityCode.FAC_FILTER), "OTS_InterpositionFilter::preDispatch ( "+op+" )");
	}
	...
	if (!problem || otsNeedTranContext)
	{
		...
		{
		    ErrorStream.stream(ErrorStream.FATAL).println("OTS_InterpositionFilter received transaction context but could not deal with it!");
...
public org.omg.CORBA.portable.OutputStream postDispatch (org.omg.CORBA.DynamicImplementation p, String op,
	...
	{
	    DebugController.controller().print(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					       (FacilityCode.FAC_OTS | FacilityCode.FAC_FILTER), "OTS_InterpositionFilter::postDispatch ( "+op+" )");
	}
	...
	{
	    ErrorStream.stream(ErrorStream.WARNING).println("OTS_InterpositionFilter.postDispatch caught: "+ex);
	    return buf;
	}
	catch (Exception e)
	{
	    ErrorStream.stream(ErrorStream.WARNING).println("OTS_InterpositionFilter.postDispatch caught exception.");
	    return buf;
	}
