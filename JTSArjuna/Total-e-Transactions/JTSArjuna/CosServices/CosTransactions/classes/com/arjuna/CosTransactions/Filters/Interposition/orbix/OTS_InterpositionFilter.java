 ...
 * UK.  
 *
 * $Id: OTS_InterpositionFilter.java,v 1.1.2.1.4.1.4.4.4.2.2.1.22.1.2.1 2000/11/24 14:37:35 nmcl Exp $
 */
...
public boolean outRequestPreMarshal (Request r)
	...
	if (DebugController.enabled())
	{
	    DebugController.controller().print(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					       (FacilityCode.FAC_OTS | FacilityCode.FAC_FILTER), "OTS_InterpositionFilter::outRequestPreMarshal ( "+r+" )");
	}
...
public boolean outReplyPreMarshal (Request r)
	...
	{
	    DebugController.controller().print(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					       (FacilityCode.FAC_OTS | FacilityCode.FAC_FILTER), "OTS_InterpositionFilter::outReplyPreMarshal ( "+r+" )");
	}
	...
	{
	    ErrorStream.stream(ErrorStream.WARNING).println("OTS_InterpositionFilter::outReplyPreMarshal caught: "+ex);
	    
	    return false;
	}
	catch (Exception e)
	{
	    ErrorStream.stream(ErrorStream.WARNING).println("OTS_InterpositionFilter::outReplyPreMarshal caught exception: "+e);
...
public boolean inRequestPreMarshal (Request r)
	...
	{
	    DebugController.controller().print(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					       (FacilityCode.FAC_OTS | FacilityCode.FAC_FILTER), "OTS_InterpositionFilter::inRequestPreMarshal ( "+r+" )");
	}
	...
	{
	    /*
	     * OK, we are transactional and expect some context information,
	     * even if it zero.
	     */
...
public boolean inReplyPreMarshal (Request r)
	...
	{
	    DebugController.controller().print(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					       (FacilityCode.FAC_OTS | FacilityCode.FAC_FILTER), "OTS_InterpositionFilter::inReplyPreMarshal ( "+r+" )");
	}
...
public void outReplyFailure (Request r, Exception ex)
	...
	{
	    DebugController.controller().print(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					       (FacilityCode.FAC_OTS | FacilityCode.FAC_FILTER), "OTS_InterpositionFilter::outReplyFailure ( "+r+" )");
	}
	...
	{
	    ErrorStream.stream(ErrorStream.WARNING).println("OTS_InterpositionFilter::outReplyFailure caught: "+e1);
	}
	catch (Exception e2)
	{
	    ErrorStream.stream(ErrorStream.WARNING).println("OTS_InterpositionFilter::outReplyFailure caught exception: "+e2);
	}
    }
