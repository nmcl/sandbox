 ...
 * UK.
 *
 * $Id: Init.java,v 1.1 2000/02/25 14:06:11 nmcl Exp $
 */
...
public void init (org.omg.CORBA.ORB orb)
	...
	catch (Exception e)
	{
        ...
        try
        {
            ...
            bindManager.add(new OTS_InterpositionBindInterceptor());
        }
        catch (Exception e)
        {
	    e.printStackTrace();
        ...
        try
        {
            ...
            poaManager.add(new OTS_InterpositionPOALifeCycleInterceptor());
        }
        catch (Exception e)
        {
	    e.printStackTrace();
