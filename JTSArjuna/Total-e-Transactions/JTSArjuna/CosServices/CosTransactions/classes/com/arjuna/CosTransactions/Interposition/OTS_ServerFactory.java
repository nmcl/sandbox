 ...
 * UK.  
 *
 * $Id: OTS_ServerFactory.java,v 1.3.2.1.4.1.2.2.8.1.10.1.4.1.8.1.14.1.14.1.66.3 2002/11/20 16:34:37 nmcl Exp $
 */
 ...
 * @version $Id: OTS_ServerFactory.java,v 1.3.2.1.4.1.2.2.8.1.10.1.4.1.8.1.14.1.14.1.66.3 2002/11/20 16:34:37 nmcl Exp $
 * @since JTS 1.2.4.
 */
...
public static org.omg.CosTransactions.Status getOSStatus (Uid u) throws NoTransaction, SystemException
    {
	OTS_RecoveredServerTransaction rt = new OTS_RecoveredServerTransaction(u);
