 ...
 * UK.  
 *
 * $Id: JTA_XID.java,v 1.1.28.3.4.1.10.1 2001/04/06 12:02:25 nmcl Exp $
 */
 ...
 * @version $Id: JTA_XID.java,v 1.1.28.3.4.1.10.1 2001/04/06 12:02:25 nmcl Exp $
 * @since JTS 1.2.4.
 */

public class JTA_XID implements javax.transaction.xa.Xid, Serializable
{
...
public JTA_XID (OTS_ControlWrapper c)
    {
	this(c, false);
    }
    
public JTA_XID (OTS_ControlWrapper c, boolean branch)
    {
	try
	{
	    _theXid = c.get_xid(branch);
...
public byte[] getBranchQualifier ()
	...
	if (_theXid != null)
	{
	    ...
	    for (int i = 0; i < b.length; i++)
	    {
		b[i] = _theXid.data[i+_theXid.gtrid_length];
	    }
