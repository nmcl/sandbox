 ...
 * UK.  
 *
 * $Id: cloudscape_6_1.java,v 1.1.2.2 2001/10/18 11:27:15 nmcl Exp $
 */
...
public class cloudscape_3_6 implements JDBCImple
{
...
public cloudscape_3_6
	...
	_preparedStatements = new PreparedStatement[cloudscape_6_1.STATEMENT_SIZE];

	for (int i = 0; i < cloudscape_6_1.STATEMENT_SIZE; i++)
...
public boolean write_state (Uid objUid, String tName, OutputObjectState state, int s) throws ObjectStoreException
	...
	if (tName != null)
	{
	    ...
	    if (imageSize > cloudscape_6_1._maxStateSize)
		throw new ObjectStoreException("Object state is too large - maximum size allowed: "+cloudscape_6_1._maxStateSize);
