 ...
 * UK.  
 *
 * $Id: oracle_9_0.java,v 1.1.2.1 2002/06/17 12:47:01 nmcl Exp $
 */
...
public class oracle_9_0 implements JDBCImple
{
...
public oracle_9_0 ()
	...
	_preparedStatements = new PreparedStatement[oracle_9_0.STATEMENT_SIZE];

	for (int i = 0; i < oracle_9_0.STATEMENT_SIZE; i++)
