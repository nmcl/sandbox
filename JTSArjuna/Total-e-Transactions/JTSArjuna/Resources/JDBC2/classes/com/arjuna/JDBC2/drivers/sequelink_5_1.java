 ...
 * UK.  
 *
 * $Id: sequelink_5_1.java,v 1.1.2.1.42.1 2001/07/19 14:16:09 nmcl Exp $
 */
...
public class sequelink_5_1 implements ArjunaJDBC2DynamicClass
{
...
public synchronized XADataSource getDataSource (String dbName, boolean create) throws SQLException
	...
	try
	{
	    ...
	    if (index1 == -1)
		throw new SQLException("sequelink_5_1.getDataSource - db "+dbName+" not for Merant");
	    else
	    {
		/*
	...
	{
	    throw new SQLException("sequelink_5_1 caught: " +e2);
	}
    }
