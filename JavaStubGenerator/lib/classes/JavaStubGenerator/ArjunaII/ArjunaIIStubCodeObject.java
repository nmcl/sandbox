 ...
 * UK.
 *
 * $Id: ArjunaIIStubCodeObject.java,v 1.2 1997/08/05 14:35:45 nmcl Exp $
 */
...
public class ArjunaIIStubCodeObject implements StubCodeObject
{

public ArjunaIIStubCodeObject (String extension)
    {
...
public void produceStubCode (Method[] methods) throws IOException
    {
	FileOutputStream stubFile = new FileOutputStream(_interfaceName+_extension+StubCodeGenerator.javaExtension);
	PrintWriter stream = new PrintWriter(stubFile);
	String stubClassName = _interfaceName+_extension;
...
public void produceStubCode (Constructor[] constructors, Method[] methods) throws IOException
	...
	produceStubCode(methods);
    }

public void addPackages (PrintWriter stream)
    {
	stream.println("import "+_interfaceName+";");
...
public void addConstructor (String stubClassName, PrintWriter stream)
	...
	stream.println("\t\t_obj = ("+_interfaceName+") _binder.bind(binderInfo);");
...
public void addVariables (PrintWriter stream)
    {
	stream.println("private "+_interfaceName+" _obj;");
