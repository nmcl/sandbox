...
Boolean ClassType::produceAllStubs ( ostream& masterHdr )
{
	...
	Boolean produceJava = (GlobalInfo::getOutputStyle() == JAVA_STYLE) ? TRUE : FALSE;
...
Boolean ClassType::produceJavaCode (ostream& codeStream)
{
	...
	codeStream << "import RPC.ClientTCPPort;\n";
	codeStream << "import RPC.PortAddress;\n";
	codeStream << "import RPC.InputBuffer;\n";
	codeStream << "import RPC.OutputBuffer;\n";
	codeStream << "import Wrappers.*;\n";
	codeStream << "\n";
	...
	codeStream << "private ClientRpcManager _clientManager_;\n";
