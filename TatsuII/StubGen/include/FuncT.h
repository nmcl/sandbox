 ...
 * UK.
 *
 * $Id: FuncT.h,v 1.1 1997/06/09 19:52:14 nmcl Exp $
 */
...
private:
    ...
    void declareJavaClientLocals (ostream&);
    void doCallToServer (ostream&);
    void doJavaCallToServer (ostream&);    
    ...
    Boolean packJavaCallArgList (ostream&);
    void unpackJavaArgList (ostream&);

    Boolean printClientCode (ostream&);
    Boolean printJavaClientCode (ostream&);
