 ...
 * UK.
 *
 * $Id: Decl.cc,v 1.2 1997/06/11 20:25:10 nmcl Exp $
 */
...
static const char RCSid[] = "$Id: Decl.cc,v 1.2 1997/06/11 20:25:10 nmcl Exp $";
				       ...
				       OutputStyle inStyle )
{
    ...
    if (((inStyle == SHADOWS_STYLE) || (inStyle == CPLUSPLUS_STYLE) || (inStyle == JAVA_STYLE) || (inStyle == CPLUSPLUS_AND_JAVA_STYLE) || (inStyle == ARJUNAII_STYLE)) &&
