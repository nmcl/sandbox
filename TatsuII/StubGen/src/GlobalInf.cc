 ...
 * UK.
 *
 * $Id: GlobalInf.cc,v 1.2 1997/06/11 20:25:11 nmcl Exp $
 */
...
static const char RCSid[] = "$Id: GlobalInf.cc,v 1.2 1997/06/11 20:25:11 nmcl Exp $";
...
String GlobalInfo::javaCodeSuff(".java");
...
String GlobalInfo::version("Arjuna Stub Generator Version 6.0.0 - $Date: 1997/06/11 20:25:11 $");
