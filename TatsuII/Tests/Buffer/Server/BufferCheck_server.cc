...
{
case 14642921:
return BufferCheck14642921(theObject, work, result);
case 84735718:
...
Int32 ServerBufferCheck::BufferCheck14642921 (LocalBufferCheck * _theObject_, RpcBuffer& _work_, RpcBuffer& _result_)
{
...
{
if ((_constructRefCount_ > 0) && ((_constructOpcode_ != 14642921) || (_constructArgs_ != _savedArgs_)))
...
{
_constructedHere_ = 1;
theRealObject = new LocalBufferCheck(*Par_0_);
}
}
...
if (_work_.readState() == BUFFER_GOOD)
{
_theObject_->Test(Par_0_, *Par_1_);
_result_ << Par_1_;
}
else
_errCode_ = PARAMETER_ERROR;
